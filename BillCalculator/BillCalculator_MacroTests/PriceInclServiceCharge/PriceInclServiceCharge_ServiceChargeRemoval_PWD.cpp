...
#include "PriceInclServiceCharge_ServiceChargeRemoval_PWD.h"

//---------------------------------------------------------------------------

__fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::PriceInclServiceCharge_ServiceChargeRemoval_PWD(System::String name)
        : TTestMMBillCalculator_Base(name)
{
}
//------------------------------------------------------------------------------

__fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::~PriceInclServiceCharge_ServiceChargeRemoval_PWD()
{
}
//------------------------------------------------------------------------------
...
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_InclSimpleTax_InclSC_PWD()
{
    ...
    CheckEquals( 148.3211, getFinalPriceForCurrentResult(),    0.0001, ERR_Total );
}

void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_InclCompoundTax_InclSC_PWD()
{
    priceInfoObj->Value = 200.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
    ...
    CheckEquals( 148.4725, getFinalPriceForCurrentResult(),    0.0001, ERR_Total );
}
//------------------------------------------------------------------------------

void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_ExclSimpleTax_InclSC_PWD()
{
    ...
    CheckEquals( 101.6000, getFinalPriceForCurrentResult(),    0.0001, ERR_Total );
}

void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_ExclCompoundTax_InclSC_PWD()
{
    priceInfoObj->Value = 110.00;
    priceInfoObj->TaxInclusive = false;
    priceInfoObj->ServiceChargeInclusive = true;
    ...
    CheckEquals(  -20.0000, getTotalDiscountForCurrentResult(),      0.0001, ERR_Discounts );
    CheckEquals( 103.0400, getFinalPriceForCurrentResult(),    0.0001, ERR_Total );
}
//------------------------------------------------------------------------------

void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_ExemptTax_InclSC_PWD()
{
    priceInfoObj->Value = 110.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Persons with disability discount scenarios
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_InclSimpleTax_InclSC_InclSCT_PWD()
{
    priceInfoObj->Value = 200.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
	...
	CheckEquals( 31.3043, getTotalTaxForCurrentResult(),      0.0001, ERR_Tax );
	CheckEquals(  -28.9855, getTotalDiscountForCurrentResult(),      0.0001, ERR_Discounts );
    CheckEquals( 147.2463, getFinalPriceForCurrentResult(),    0.0001, ERR_Total );
}

void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_InclCompoundTax_InclSC_InclSCT_PWD()
{
    priceInfoObj->Value = 200.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
	...
	CheckEquals( 32.9614, getTotalTaxForCurrentResult(),      0.0001, ERR_Tax );
    ...
    CheckEquals( 147.4106, getFinalPriceForCurrentResult(),    0.0001, ERR_Total );
}
//------------------------------------------------------------------------------
/*
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_InclSimpleTax_InclSC_PWD_NoSCInExemptPrice()
{
    priceInfoObj->Value = 200.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
...
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_InclCompoundTax_InclSC_PWD_NoSCInExemptPrice()
{
    priceInfoObj->Value = 200.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
...
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_ExclSimpleTax_InclSC_PWD_NoSCInExemptPrice()
{
    priceInfoObj->Value = 110.00;
    priceInfoObj->TaxInclusive = false;
    priceInfoObj->ServiceChargeInclusive = true;
...
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_ExclCompoundTax_InclSC_PWD_NoSCInExemptPrice()
{
    priceInfoObj->Value = 110.00;
    priceInfoObj->TaxInclusive = false;
    priceInfoObj->ServiceChargeInclusive = true;
...
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_ExemptTax_InclSC_PWD_NoSCInExemptPrice()
{
    priceInfoObj->Value = 110.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Price inclusive service charge and service charge tax : No service charge in tax exempt price
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_InclSimpleTax_InclSC_InclSCT_PWD_NoSCInExemptPrice()
{
    priceInfoObj->Value = 200.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
...
void __fastcall PriceInclServiceCharge_ServiceChargeRemoval_PWD::Test_InclCompoundTax_InclSC_InclSCT_PWD_NoSCInExemptPrice()
{
    priceInfoObj->Value = 200.00;
    priceInfoObj->TaxInclusive = true;
    priceInfoObj->ServiceChargeInclusive = true;
...
static void registerTests()
{
  ...
  TTestSuite* testSuite = new TTestSuite("PriceInclServiceCharge_ServiceChargeRemoval_PWD");
  if (testSuite->GetInterface(iSuite)) {
    testSuite->AddTests(__classid(PriceInclServiceCharge_ServiceChargeRemoval_PWD));
    Testframework::RegisterTest(iSuite);
  } else {
    delete testSuite;
  }
}
#pragma startup registerTests 13
