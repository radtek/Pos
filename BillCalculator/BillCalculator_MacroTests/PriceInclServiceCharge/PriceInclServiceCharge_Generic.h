 ...
 */
class PriceInclServiceCharge_Generic : public TTestMMBillCalculator_Base
{
    public:

        __fastcall virtual PriceInclServiceCharge_Generic(System::String name);
        __fastcall virtual ~PriceInclServiceCharge_Generic();
