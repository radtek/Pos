 ...
 */
class PriceInclServiceCharge_ServiceChargeRemoval_PWD : public TTestMMBillCalculator_Base
{
    public:

        __fastcall virtual PriceInclServiceCharge_ServiceChargeRemoval_PWD(System::String name);
        __fastcall virtual ~PriceInclServiceCharge_ServiceChargeRemoval_PWD();
