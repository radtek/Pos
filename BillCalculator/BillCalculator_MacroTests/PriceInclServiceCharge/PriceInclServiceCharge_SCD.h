 ...
 */
class PriceInclServiceCharge_SCD : public TTestMMBillCalculator_Base
{
    public:

        __fastcall virtual PriceInclServiceCharge_SCD(System::String name);
        __fastcall virtual ~PriceInclServiceCharge_SCD();
