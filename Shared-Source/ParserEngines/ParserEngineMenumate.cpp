...
PARSER_ERROR apply6_55( TDBControl* inDBControl );
PARSER_ERROR apply6_56( TDBControl* inDBControl );
PARSER_ERROR apply6_57( TDBControl* inDBControl );
PARSER_ERROR apply6_58( TDBControl* inDBControl );
PARSER_ERROR apply6_59( TDBControl* inDBControl );
PARSER_ERROR apply6_60( TDBControl* inDBControl );
PARSER_ERROR apply6_61( TDBControl* inDBControl );
PARSER_ERROR apply6_62( TDBControl* inDBControl );
PARSER_ERROR apply6_63( TDBControl* inDBControl );
//::::::::::::::::::::::::::::::::::::::::::::::::::
...
void TParserEngineMenumate::populateVersionList( PARSER_FUNCTION_MAP& outVersions )
{
    ...
    outVersions["6.55"] = apply6_55;
    outVersions["6.56"] = apply6_56;
    outVersions["6.57"] = apply6_57;
    outVersions["6.58"] = apply6_58;
    outVersions["6.59"] = apply6_59;
    outVersions["6.60"] = apply6_60;
    outVersions["6.61"] = apply6_61;
    outVersions["6.62"] = apply6_62;
    outVersions["6.63"] = apply6_63;
}
// ---------------------------------------------------------------------------
...
PARSER_ERROR apply6_55( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_55,  inDBControl );
}
//------------------------------------------------
PARSER_ERROR apply6_56( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_56,  inDBControl );
}
//------------------------------------------------
PARSER_ERROR apply6_57( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_57,  inDBControl );
}
//------------------------------------------------
PARSER_ERROR apply6_58( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_58,  inDBControl );
}
//------------------------------------------------
PARSER_ERROR apply6_59( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_59,  inDBControl );
}
//------------------------------------------------
PARSER_ERROR apply6_60( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_60,  inDBControl );
}
//------------------------------------------------------
PARSER_ERROR apply6_61( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_61,  inDBControl );
}
//------------------------------------------------------
PARSER_ERROR apply6_62( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_62,  inDBControl );
}
//------------------------------------------------------
PARSER_ERROR apply6_63( TDBControl* inDBControl )
{
	return TApplyParser::Instance()->Apply( MenumateVersionParser::pv6_63,  inDBControl );
}
