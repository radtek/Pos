...
namespace MenumateVersionParser
{
    ...
    enum TParserVersions
    {
            ...
            pv6_45,pv6_46,pv6_47,pv6_48,pv6_49,pv6_50,pv6_51,pv6_52, pv6_53, pv6_54, pv6_55, pv6_56, pv6_57, pv6_58, pv6_59, pv6_60, pv6_61, pv6_62, pv6_63  };
    class TApplyParser
    {
    public:
    ...
    private:
        ...
        PARSER_ERROR apply6_54( TDBControl* const inDBControl );
        PARSER_ERROR apply6_55( TDBControl* const inDBControl );
        PARSER_ERROR apply6_56( TDBControl* const inDBControl );
        PARSER_ERROR apply6_57( TDBControl* const inDBControl );
        ...
        PARSER_ERROR apply6_62( TDBControl* const inDBControl );
        PARSER_ERROR apply6_63( TDBControl* const inDBControl );
...
//        void POPULATEDSRPIVOTProcedure6_37( TDBControl* const inDBControl );  //All of these now moved to 6.46
        ...
        void update6_53Tables();
         void upgrade6_54Tables();
         void update6_54Tables();
        ...
        void AlterTableTables6_54(TDBControl* const inDBControl);

        void upgrade6_55Tables();
        void update6_55Tables();
        void Create6_55Generators(TDBControl* const inDBControl);
        void Create6_55Tables(TDBControl* const inDBControl);
        void Create6_55TableOutlets(TDBControl* const inDBControl);
        void Create6_55TableServices(TDBControl* const inDBControl);
        void Create6_55TableSpaces(TDBControl* const inDBControl);
        void AlterTable6_55RevenueCodeDetails(TDBControl* const inDBControl);
        void Create6_55TablePMSAccountingCategories(TDBControl* const inDBControl);
        void upgrade6_56Tables();
        void update6_56Tables();
        void Create6_56Table(TDBControl* const inDBControl);
        void Create6_56Generator(TDBControl* const inDBControl);
        void upgrade6_57Tables();
        void update6_57Tables();
        ...
        void upgrade6_59Tables();
        void update6_59Tables();
        void Create6_59Table(TDBControl* const inDBControl);
        void Create6_59Generator(TDBControl* const inDBControl);
        ...
        void upgrade6_62Tables();
        void update6_62Tables();
        void Alter6_62Tables(TDBControl* const inDBControl);
        void AlterOrderTable6_62(TDBControl* const inDBControl);
        void UpdateItemIdentifierInOrders(TDBControl* const inDBControl);

        void upgrade6_63Tables();
        void update6_63Tables();
        void Alter6_63Tables(TDBControl* const inDBControl);
        void Create6_63Generator(TDBControl* const inDBControl);
        void Create6_63Table(TDBControl* const inDBControl);
