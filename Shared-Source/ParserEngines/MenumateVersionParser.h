...
//        void POPULATEDSRPIVOTProcedure6_37( TDBControl* const inDBControl );  //All of these now moved to 6.46
        ...
        void Create6_53Tables(TDBControl* const inDBControl);
        void Create6_53TableOutlets(TDBControl* const inDBControl);
        void Create6_53TableServices(TDBControl* const inDBControl);
        void Create6_53TablePromotions(TDBControl* const inDBControl);
        //void Create6_53TableCategories(TDBControl* const inDBControl);
        void Create6_53TableSpaces(TDBControl* const inDBControl);
        void AlterTable6_53RevenueCodeDetails(TDBControl* const inDBControl);
        void Create6_53TablePMSAccountingCategories(TDBControl* const inDBControl);
