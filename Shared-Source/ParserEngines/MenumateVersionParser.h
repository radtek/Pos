...
namespace MenumateVersionParser
{
    ...
    enum TParserVersions
    {
            ...
            pv6_45,pv6_46,pv6_47,pv6_48,pv6_49,pv6_50,pv6_51,pv6_52, pv6_53, pv6_54  };
...
//        void POPULATEDSRPIVOTProcedure6_37( TDBControl* const inDBControl );  //All of these now moved to 6.46
        ...
        void Create6_54Generators(TDBControl* const inDBControl);
        void Create6_54Tables(TDBControl* const inDBControl);
        void Create6_54TableOutlets(TDBControl* const inDBControl);
        void Create6_54TableServices(TDBControl* const inDBControl);
        void Create6_54TablePromotions(TDBControl* const inDBControl);
        //void Create6_53TableCategories(TDBControl* const inDBControl);
        void Create6_54TableSpaces(TDBControl* const inDBControl);
        void AlterTable6_54RevenueCodeDetails(TDBControl* const inDBControl);
        void Create6_54TablePMSAccountingCategories(TDBControl* const inDBControl);
