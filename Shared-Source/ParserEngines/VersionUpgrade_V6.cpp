...
//-----------------------------------------------------------------------------
PARSER_ERROR TApplyParser::apply6_48( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.48";
	previous_version = "6.47";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
//-----------------------------------------------------------------------------
PARSER_ERROR TApplyParser::apply6_49( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
...
PARSER_ERROR TApplyParser::apply6_50( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
...
//-----------------------------------------------------------------------------
PARSER_ERROR TApplyParser::apply6_52( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.52";
	previous_version = "6.51";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
//--------------------------------------------------------------------------
PARSER_ERROR TApplyParser::apply6_54( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.54";
	previous_version = "6.53";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
//-----------------------------------------------------------------------------
PARSER_ERROR TApplyParser::apply6_55( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.55";
	previous_version = "6.54";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
//-----------------------------------------------------------------------------
PARSER_ERROR TApplyParser::apply6_56( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.56";
	previous_version = "6.55";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
//-----------------------------------------------------------------------------
PARSER_ERROR TApplyParser::apply6_57( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.57";
	previous_version = "6.56";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
//-----------------------------------------------------------------------------
PARSER_ERROR TApplyParser::apply6_60( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.60";
	previous_version = "6.59";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
PARSER_ERROR TApplyParser::apply6_61( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.61";
	previous_version = "6.60";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
PARSER_ERROR TApplyParser::apply6_62( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.62";
	previous_version = "6.61";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
...
PARSER_ERROR TApplyParser::apply6_63( TDBControl* const inDBControl )
{
  	_dbControl = inDBControl;
	_errorMsg.clear();
	current_version  = "6.63";
	previous_version = "6.62";
	// Previous Version.
	if( !updateAlreadyApplied( previous_version,  _dbControl ) )
	{
		_errorMsg.append( "Version " + previous_version + " required." );
