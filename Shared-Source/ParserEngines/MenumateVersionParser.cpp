                              ...
                              TDBControl* const inDBControl )
{
    switch( inVersion )
    {
        ...
        case pv6_44 : return apply6_44( inDBControl );
        case pv6_45 : return apply6_45( inDBControl );
        case pv6_46 : return apply6_46( inDBControl );
        case pv6_47 : return apply6_47( inDBControl );
        case pv6_48 : return apply6_48( inDBControl );
        case pv6_49 : return apply6_49( inDBControl );
        case pv6_50 : return apply6_50( inDBControl );
        case pv6_51 : return apply6_51( inDBControl );
        case pv6_52 : return apply6_52( inDBControl );
        case pv6_53 : return apply6_53( inDBControl );
        case pv6_54 : return apply6_54( inDBControl );
        case pv6_55 : return apply6_55( inDBControl );
        case pv6_56 : return apply6_56( inDBControl );
        case pv6_57 : return apply6_57( inDBControl );
        case pv6_58 : return apply6_58( inDBControl );
        case pv6_59 : return apply6_59( inDBControl );
        case pv6_60 : return apply6_60( inDBControl );
        case pv6_61 : return apply6_61( inDBControl );
        case pv6_62 : return apply6_62( inDBControl );
        case pv6_63 : return apply6_63( inDBControl );
