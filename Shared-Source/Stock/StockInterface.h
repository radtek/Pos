...
//---------------------------------------------------------------------------
enum TStockAdjustType { saSale, saWriteOff,saRefund};
//---------------------------------------------------------------------------
class TvMMControls
{
public:
...
public:
	...
	bool AdjustStock(AnsiString StockCode, AnsiString Location, double Qty, TStockAdjustType AdjustType, AnsiString Operator, AnsiString Reason, AnsiString DeviceName);
	bool EndAdjustments();
