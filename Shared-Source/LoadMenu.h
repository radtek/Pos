...
public:
    ...
    __int32 SizeCount();
    __int32 SizeAtIndex( __int32 inIndex, __int32& outKey, AnsiString& outDescription, AnsiString& outKitchenName,
    ...
    __int32 CategoryGroupAtIndex( __int32 inIndex, __int32& outKey, AnsiString& outDescription, bool& outGetDeleted );

    __int32 CategoryCount(   __int32 inCategoryGroupHandle );
    bool    CategoryAtIndex( __int32 inIndex, __int32 inCategoryGroupHandle, __int32& outKey, AnsiString& outDescription, AnsiString& outGLCode, bool& outGetDeleted );

    __int32 AllTaxProfilesCount();
    __int32 TaxProfileAtIndex( __int32 inIndex,  __int32& outKey, AnsiString& outName, Currency& outRate,
                               __int32& outType, __int32& outPriority );

    __int32 ServingCourseCount();
    __int32 ServingCourseAtIndex( __int32 inIndex, __int32& outKey, AnsiString& outLongDescription, AnsiString& outKitchenName,
                                  bool& outEnabled, bool& outDeleted, bool& outSelectable, TColor& outColor,__int32& displayOrder );

    __int32 ThirdPartyCodeCount();
    __int32 ThirdPartyCodeAtIndex( __int32 inIndex, __int32& outKey, AnsiString& outCode, AnsiString& outDescription, bool& outVisible,
                                   __int32& outCodeType );

     __int32 CourseCount();
     __int32 CourseAtIndex( __int32 inIndex, __int32& outKey, AnsiString& outDescription, AnsiString& outKitchenName,
    ...
    __int32 ItemAtIndex( __int32 inIndex, __int32 inCourseHandle, __int32& outKey, AnsiString& outLongDescription,
   ...
   __int32 OptionCount(   __int32 inCourseID );
	__int32 OptionAtIndex( __int32 inIndex, __int32 inCourseID, __int32& outKey, AnsiString& outLongDescription,
                           AnsiString& outKitchenName, AnsiString& outHandheldName, AnsiString& outReceiptName,
    ...
    __int32 ItemSizeAtIndex( __int32 inIndex, __int32 inItemHandle, __int32& outKey, __int32& outSizeFKey, AnsiString& outLongDescription,
                             AnsiString& outSizeKitchenName,
                             bool& outFree, Currency& outPrice, Currency& outMaxRetailPrice, Currency& outSpecialPrice,
                             double& outGST, Currency& outCost, double& outCostGST,
                             double& outPointsPercent, __int32& outMemberPurchaseCount,
							        double& outMemberPurchaseDiscount, __int32& outLocationPurchaseCount,
                             double& outLocationPurchaseDiscount, bool& outNoRecipe,
                             bool& outIsTaxExempt, bool& outHasServiceCharge,
                             __int32& outSetMenuMask, bool& outAvailableAsStandard,
                             AnsiString& outBarcode, bool& outEnabled,
                             __int32& outCategoryKey, AnsiString& outCategory,
                             __int32& outThirdPartyCodeKey, double& outTareWeight, __int32& outPLU,
                             double &outAvailableQuantity,
                             double &outDefaultQuantity,
                             double &outWarningQuantity,
                             bool &outDisableWhenCountReachesZero,
                             bool &outCanBePaidForUsingPoints,
                             int &outDefaultPatronCount,
                             Currency& outPriceForPoints);  // add price for points 

    __int32 BCategoryCount(   __int32 inItemSizeHandle );
    __int32 BCategoryAtIndex( __int32 inIndex, __int32 inItemSizeHandle, __int32& outKey, AnsiString& outDescription );

    __int32 ItemSizeReceipeCount(   __int32 inItemSizeHandle );
    __int32 ItemSizeReceipeAtIndex( __int32 inIndex, __int32 inItemSizeHandle, __int32& outKey, AnsiString& outStockCode,
