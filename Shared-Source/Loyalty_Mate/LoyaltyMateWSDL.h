...
private:
  ...
  UnicodeString   FMenumateVersionSystemName;
  bool            FMenumateVersionSystemName_Specified;
  UnicodeString   FName;
  bool            FName_Specified;
  ...
  __int64         FSiteId;
  bool            FSiteId_Specified;
  UnicodeString   FTerminalCode;
  bool            FTerminalCode_Specified;
  ...
  void __fastcall SetMenumateVersionSystemName(int Index, UnicodeString _prop_val)
  {  FMenumateVersionSystemName = _prop_val; FMenumateVersionSystemName_Specified = true;  }
  bool __fastcall MenumateVersionSystemName_Specified(int Index)
  {  return FMenumateVersionSystemName_Specified;  } 
  void __fastcall SetName(int Index, UnicodeString _prop_val)
  {  FName = _prop_val; FName_Specified = true;  }
  bool __fastcall Name_Specified(int Index)
  {  return FName_Specified;  } 
  ...
  bool __fastcall SiteId_Specified(int Index)
  {  return FSiteId_Specified;  } 
  void __fastcall SetTerminalCode(int Index, UnicodeString _prop_val)
  {  FTerminalCode = _prop_val; FTerminalCode_Specified = true;  }
  bool __fastcall TerminalCode_Specified(int Index)
  {  return FTerminalCode_Specified;  } 
...
__published:
  ...
  __property UnicodeString MenumateVersionSystemName = { index=(IS_OPTN|IS_NLBL), read=FMenumateVersionSystemName, write=SetMenumateVersionSystemName, stored = MenumateVersionSystemName_Specified };
  __property UnicodeString       Name = { index=(IS_OPTN|IS_NLBL), read=FName, write=SetName, stored = Name_Specified };
  ...
  __property __int64        SiteId = { index=(IS_OPTN), read=FSiteId, write=SetSiteId, stored = SiteId_Specified };
  __property UnicodeString TerminalCode = { index=(IS_OPTN|IS_NLBL), read=FTerminalCode, write=SetTerminalCode, stored = TerminalCode_Specified };
...
public:
  ...
  virtual void            UpdateRegistrationDetails(const Site* siteInfo) = 0; 
};
