...
//---------------------------------------------------------------------------
void __fastcall TTouchGrid::GridCompleteScroll(Touchgrid::TScrollDirection ScrollDirection, int Distance)
{
	if (FScroll && FCurrentScrollButton)
	{
		ApplyScroll();
...
//---------------------------------------------------------------------------
void TTouchGrid::Scroll(Touchgrid::TScrollDirection Direction)
{
	if (Direction == sdUp)
	{
...
//---------------------------------------------------------------------------
void TTouchGrid::HorizSmoothScroll(Touchgrid::TScrollDirection Direction, int Distance, int Time)
{
	TRect Rect = GridInnerRect;
	InflateRect(&Rect, -FGridBorderWidth, -FGridBorderWidth);
...
//---------------------------------------------------------------------------
void TTouchGrid::VertSmoothScroll(Touchgrid::TScrollDirection Direction, int Distance, int Time)
{
	TRect Rect = GridInnerRect;
	InflateRect(&Rect, -FGridBorderWidth, -FGridBorderWidth);
...
//
				...
				AnsiString Temp = "";
				Temp.SetLength(Data);
				Stream->ReadBuffer(Temp.c_str(), Data);
				GridButton->Caption = Temp;
...
/*				Stream->ReadBuffer(&Data, sizeof(Data));
				wchar_t *StrData = new wchar_t[Data];
				Stream->ReadBuffer(StrData, Data);
				GridButton->Caption = UnicodeString(StrData,Data);
				delete[] StrData;*/
...
/*				Stream->ReadBuffer(&Data, sizeof(Data));
				GridButton->Caption.SetLength(Data);
				Stream->ReadBuffer(GridButton->Caption.data(), Data);
*/
				Stream->ReadBuffer(&Data, sizeof(Data));
				GridButton->Enabled = Data;
...
//
			...
			AnsiString Temp = GridButton->Caption;
			Data = Temp.Length();
			Stream->WriteBuffer(&Data, sizeof(Data));
			Stream->WriteBuffer(Temp.c_str(), Data);
...
//---------------------------------------------------------------------------
void TGridScrollThread::Scroll(Touchgrid::TScrollDirection iDirection, int iDistance, int iTime)
{
