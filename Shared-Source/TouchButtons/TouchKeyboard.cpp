...
//
static inline void ValidCtrCheck(TMMTouchKeyboard *)
{
	new TMMTouchKeyboard(NULL);
}
//---------------------------------------------------------------------------
__fastcall TMMTouchKeyboard::TMMTouchKeyboard(TComponent* Owner) : TCustomTouchButtonControl(Owner)
{
...
//---------------------------------------------------------------------------
void TMMTouchKeyboard::SetCaptions()
{
...
//---------------------------------------------------------------------------
const TBtnText &TMMTouchKeyboard::GetBtnText(int ButtonIndex)
{
...
//---------------------------------------------------------------------------
void __fastcall TMMTouchKeyboard::Paint(void)
{
...
//---------------------------------------------------------------------------
TGridButton *TMMTouchKeyboard::GetButtonXY(int X, int Y)
{
	for (unsigned i=0; i<FButtons.size(); i++)
	{
...
//---------------------------------------------------------------------------
TRect TMMTouchKeyboard::GetButtonRect(const TGridButton *Button)
{
...
//---------------------------------------------------------------------------
void __fastcall TMMTouchKeyboard::SetGridBorderWidth(int GridBorderWidth)
{
	FGridBorderWidth	= GridBorderWidth;
	Invalidate();
}
//---------------------------------------------------------------------------
void __fastcall TMMTouchKeyboard::SetBtnGapWidth(int Width)
{
	FBtnGapWidth = Width;
	Invalidate();
}
//---------------------------------------------------------------------------
void __fastcall TMMTouchKeyboard::SetBtnGapHeight(int Height)
{
	FBtnGapHeight = Height;
	Invalidate();
}
//---------------------------------------------------------------------------
void	__fastcall TMMTouchKeyboard::SetButtonColor(TColor Value)
{
	FButtonColor = Value;
	for (unsigned i=0; i<FButtons.size(); i++)
	{
...
//---------------------------------------------------------------------------
void	__fastcall TMMTouchKeyboard::SetShift(bool Value)
{
	FShift = Value;
	Invalidate();
}
//---------------------------------------------------------------------------
void	__fastcall TMMTouchKeyboard::SetCapsLock(bool Value)
{
	FCapsLock = Value;
	Invalidate();
}
//---------------------------------------------------------------------------
void __fastcall TMMTouchKeyboard::MouseDown(TMouseButton Button, Classes::
...
//---------------------------------------------------------------------------
void __fastcall TMMTouchKeyboard::MouseUp(TMouseButton Button, Classes::
	TShiftState Shift, int X, int Y)
{
	bool CallDefaultHandler = false;
	TGridButton *GridButton = GetButtonXY(X, Y);
