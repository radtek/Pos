...
{
    public class ReservableTableView : Control
    {
        ...
        public ReservableTableView() : base()
        {
...
//            this.Parent.Invalidate(rc, false);
        ...
        {
            Font txtFont = new Font("Arial", 7, FontStyle.Bold);
    ...
    public class ReservableRoundTableView : ReservableTableView
    {
        public ReservableRoundTableView() : base()
        {
        }
