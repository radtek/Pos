...
*/                    
    ...
    class RectTracker : System.Windows.Forms.UserControl
    {
        /// <summary> 
        ...
        public RectTracker(Control theControl)
        {
            ...
            MouseLeave += new EventHandler(RectTracker_MouseLeave);
        }

        void RectTracker_MouseLeave(object sender, EventArgs e)
        {
            //this.Visible = false;
        }
