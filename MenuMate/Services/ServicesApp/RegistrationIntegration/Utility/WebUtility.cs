...
namespace RegistrationIntegration.Utility
{
    public class WebUtility
    {
            ...
            string requestMode)
        {
            ...
            var requestUri = File.ReadAllText(@"C:\Program Files\MenuMate\Menumate Services\RegistrationRequestAddress.txt") + requestaddress;
            if (parameters != null)
            {
