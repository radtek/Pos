...
namespace WebMateTests
{
    ...
    ///</summary>
    [TestClass()]
    public class GetGUIDFromWebOrderKeyTest
    {
        ...
        public void getGUIDFromWebOrderKeyTest()
        {
            string guid = target.getGuidFromWebOrderKey(WebMateTestSettings.WebOrderKey);
