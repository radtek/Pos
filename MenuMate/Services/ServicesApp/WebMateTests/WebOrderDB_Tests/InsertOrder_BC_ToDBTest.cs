...
namespace WebMateTests
{
    ...
    ///</summary>
    [TestClass()]
    public class InsertOrder_BC_ToDBTest
    {
        ...
        public void insertOrder_BC_ToDBTest()
        {
            ...
            target.insertOrderBaseDataToDB(
                                          target.connection_,
                                          target.transaction_,
                                          ref order);

            bool result = target.insertOrderBreakdownCategoriesToDB(
                                                target.connection_,
                                                target.transaction_,
                                                order.OrderKey,
                                                order.Categories);
