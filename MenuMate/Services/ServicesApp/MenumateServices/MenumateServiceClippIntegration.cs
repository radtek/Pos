...
{
    partial class MenumateServiceClippIntegration : ServiceBase
    {
        private ClippIntegrationServiceRunner _clippIntegrationServiceRunner;

        public MenumateServiceClippIntegration()
        {
            InitializeComponent();
        }
        ...
        {
            _clippIntegrationServiceRunner = CreateRunner(ServiceName);
            _clippIntegrationServiceRunner.Start();
        }

        protected ClippIntegrationServiceRunner CreateRunner(string inServiceName)
        {
            return new ClippIntegrationServiceRunner
            {
        ...
        {
            _clippIntegrationServiceRunner.Stop();
        }

        protected void PauseRunner()
        {
            _clippIntegrationServiceRunner.Pause();
        }

        protected void ResumeRunner()
        {
            _clippIntegrationServiceRunner.Resume();
        }
    }
}
