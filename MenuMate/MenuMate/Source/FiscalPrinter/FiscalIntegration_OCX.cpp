...
// $Rev: 18756 $
// File generated on 23/03/2018 12:12:06 p.m. from Type Library described below.
...
BSTR __fastcall TFiscalLibraryClass::get_Saletype(void)
{
  return  GetDefaultInterface()->get_Saletype();
}
