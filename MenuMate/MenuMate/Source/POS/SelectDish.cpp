...
//------------------------------------------------------------------------------
TSiteMenuInfo TfrmSelectDish::GetMenuInfo(Database::TDBTransaction &dbTransaction)
{
    Database::TDBTransaction dBTransaction(TDeviceRealTerminal::Instance().DBControl);
	dBTransaction.StartTransaction();
...
//-------------------------------------------------------------------------------
std::list<TCourseInfo> TfrmSelectDish::GetCourseInfo(Database::TDBTransaction &dbTransaction, int menuKey)
{
...
//------------------------------------------------------------------------------
std::list<TSiteItemInfo> TfrmSelectDish::GetItemInfo(Database::TDBTransaction &dbTransaction, int courseId)
{
...
//------------------------------------------------------------------------------
std::list<TItemSizeInfo> TfrmSelectDish::GetItemSizeInfo(Database::TDBTransaction &dbTransaction, int itemId)
{
...
//------------------------------------------------------------------------------
std::list<TItemSizeTaxProfileInfo> TfrmSelectDish::GetItemSizeTaxProfileInfo(Database::TDBTransaction &dbTransaction, int itemSizeKey)
{
...
//------------------------------------------------------------------------------
std::list<TSideGroupInfo> TfrmSelectDish::GetSideGroupInfo(Database::TDBTransaction &dbTransaction, int masterItemKey)
{
...
//------------------------------------------------------------------------------
std::list<TItemSideInfo> TfrmSelectDish::GetItemSideInfo(Database::TDBTransaction &dbTransaction, int masterItemKey, int groupNo)
{
