...
#ifndef ManagerStockH
#define ManagerStockH
//---------------------------------------------------------------------------
...
{
	private:
		void UpdateStock(Database::TDBTransaction &DBTransaction,TItemComplete *Order, AnsiString Operator = "");
		void UpdateStock(Database::TDBTransaction &DBTransaction,TItemCompleteSub *Order, AnsiString Operator = "");
	...
	public :
		...
		void UpdateStock(Database::TDBTransaction &DBTransaction,TList *OrderObjects, AnsiString Operator = "");
