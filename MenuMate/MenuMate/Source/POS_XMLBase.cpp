...
void TPOS_XMLBase::SaveToFile(UnicodeString ID)
{
	Doc.SaveFile(UnicodeString(_T("IM Sent ") + ID + Name + _T(".xml")).c_str());
	ResultDoc.SaveFile(UnicodeString("IM Received " + ID + Name + ".xml").c_str());
}
