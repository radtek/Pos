...
enum discount_list_combo_filter_t {
    exclude_combos,
    include_combos,
    only_combos
};
...
class TManagerDiscount
{
   ...
   __property bool Enabled  = { read=GetEnabled, write=SetEnabled };
    ...
    void GetVoucherListThor(Database::TDBTransaction &,
                         TStringList *destination_list,
                         bool ShowPointsAsDiscount = true);
    void GetDiscountList(Database::TDBTransaction &,
                         TStringList *destination_list,
                         const discount_list_combo_filter_t filter =
                           include_combos, bool ShowPointsAsDiscount = true);
   ...
   int GetDiscountKeyByID(Database::TDBTransaction &DBTransaction,BYTE DiscountID);
   BYTE GetDiscountIDByKey(Database::TDBTransaction &DBTransaction,long DiscountKey);
   void DiscountIDToKey(Database::TDBTransaction &DBTransaction,std::set<byte> &AutoAppliedDiscountsID, std::set<int> &AutoAppliedDiscounts);
   void DiscountKeyToID(Database::TDBTransaction &DBTransaction,std::set<byte> &AutoAppliedDiscountsID, std::set<int> &AutoAppliedDiscounts);
   ...
   bool DiscountIDExisits(Database::TDBTransaction &DBTransaction,long DiscountKey, int DiscountID);
