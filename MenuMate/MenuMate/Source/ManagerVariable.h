...
enum vmVariables
{
   ...
   vmPMSRoundingAccountSiHot, vmSiHotRounding,vmSiHotDefaultTransaction,vmSiHotDefaultTransactionName, vmEnableCustomerJourney,vmRevenueCentre, vmPMSAPIKey, vmRoomServiceRevenueCenter,vmRoomServiceMenu,
	// Stock Master ----------------------------------------------------------------
