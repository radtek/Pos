...
enum vmVariables
{
   ...
   // MallExport ------------------------------------------------------------
    ...
    vmPrintCardHolderReceipt, vmPrintMerchantReceipt, vmRestartServiceAtZED,vmSendNoTaxToSihot,vmRevenueCodeDiscountPart,vmEnableOnlineOrdering, vmEnableItemDetailsPosting
};
