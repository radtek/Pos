...
class TDBContacts
{
	...
	void GetContactNameList(Database::TDBTransaction &DBTransaction, std::vector<ContactGroup> &vectorMembers, bool inProfile);
		...
		static int GetContactByEmail(Database::TDBTransaction &DBTransaction,UnicodeString Email);
        ...
        static bool GetContactDetailsByMemberCode(Database::TDBTransaction &DBTransaction,TMMContactInfo &Info);
