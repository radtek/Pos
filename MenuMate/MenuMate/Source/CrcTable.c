...
*
*  CONTENTS:   A lookup table to generate the XMODEM CRC.
*
*
****************************************************************************/
...
/* Lookup table used to generate XMODEM CRCs.

   This table was generated using the following algorithm:
   ...
   Reference: Embedded Systems Programming, January 1992, Implementing CRCs
              by Jack W Crenshaw.
*/
