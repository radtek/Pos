#ifndef ConsolidatedEndOfDayReportBuilderH
#define ConsolidatedEndOfDayReportBuilderH
...
class ConsolidatedEndOfDayReportBuilder : public BaseReportBuilder
{
public:
	ConsolidatedEndOfDayReportBuilder(ReportType reportType, TGlobalSettings* globalSettings, Database::TDBTransaction*  dbTransaction, TDateTime* startTime, TDateTime* endTime);
	~ConsolidatedEndOfDayReportBuilder();
