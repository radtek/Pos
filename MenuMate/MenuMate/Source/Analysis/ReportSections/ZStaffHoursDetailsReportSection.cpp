...
ZStaffHoursDetailsReportSection::ZStaffHoursDetailsReportSection(Database::TDBTransaction* dbTransaction, TGlobalSettings* globalSettings)
	:BaseReportSection(mmZReport, mmStaffHoursDetailsSection, dbTransaction, globalSettings)
{
...
ZStaffHoursDetailsReportSection::ZStaffHoursDetailsReportSection(Database::TDBTransaction* dbTransaction, TGlobalSettings* globalSettings, TDateTime* startTime, TDateTime* endTime)
	:BaseReportSection(mmZReport, mmStaffHoursDetailsSection, dbTransaction, globalSettings, startTime, endTime)
{
    dataFormatUtilities = new DataFormatUtilities;
    dataCalculationUtilities = new DataCalculationUtilities;
}
...
ZStaffHoursDetailsReportSection::~ZStaffHoursDetailsReportSection()
{
