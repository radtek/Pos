...
XCancelsAndRefundDetailsForBIRReportSection::XCancelsDetailsReportSection(Database::TDBTransaction* dbTransaction, TGlobalSettings* globalSettings)
	:BaseReportSection(mmXReport, mmRefundCancelDetailsSections, dbTransaction, globalSettings)
{
    dataFormatUtilities = new DataFormatUtilities;
}

XCancelsAndRefundDetailsForBIRReportSection::~XCancelsDetailsReportSection()
{
