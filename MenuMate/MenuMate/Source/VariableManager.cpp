...
void TManagerVariable::InitialisePOSVars(Database::TDBTransaction &DBTransaction)
{
	...
	/*	SetVarStr(vmChefMateIP, "ChefMate IP Address",
		...
		SetVarStr(DBTransaction,vmStockDatabasePath, "Stock Database Path",
					 "This should be set to the path of the Stock.ib file as it resides on the server.\r"
					 "This is not a network mapped path. It is the Path as the server machine sees the Stock.ib file.\r"
					 " Normally it is C:\\Program Files\\MenuMate\\Stock.ib",
					 vmgNetwork, "C:\\Program Files\\MenuMate\\Stock.ib");
...
/*		SetVarBool(DBTransaction,vmRavellItemsWithPriceAdjusts, "Ravel up Price Adjusted items on Receipts.",
		...
		SetVarInt(DBTransaction,vmEBetID, "EBet Membership Till ID",
		...
		SetVarStr(DBTransaction,vmMembershipDatabasePath, "Membership Database Path",
					 "This should be set to the path of the Membership.ib file as it resides on the server.\r"
					 "This setting is only use for 3rd party membership products.\r"
					 " Normally it is C:\\Program Files\\MenuMate\\Membership.ib",
					 vmgNetwork, "C:\\Program Files\\MenuMate\\Membership.ib");
      ...
      SetVarStr(DBTransaction,vmIntaMateIPAddress, "IntaMate IP Address",
		...
		SetVarStr(DBTransaction,vmPocketVoucherURL, "Pocket Voucher URL",
					 ...
					 "Default is http://wsdl.POCKETvouchers.com/Menumate/dev1.asp",
					 vmg3rdPartyInterface, "http://wsdl.POCKETvouchers.com/Menumate/dev1.asp");
