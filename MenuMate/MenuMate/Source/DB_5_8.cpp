...
void DB_5_8::Up_5_8(Database::TDBControl &DBControl)
{
...
void DB_5_8::Down_5_8(Database::TDBControl &DBControl)
{
	...
	try
	{
		...
		{
			IBQuery1->Close();
			IBQuery1->SQL->Text = "ALTER TABLE CONTACTS DROP COLUMN LOADED_POINTS";
			IBQuery1->ExecQuery();
		}
		...
		{
			IBQuery1->Close();
			IBQuery1->SQL->Text = "ALTER TABLE CONTACTS DROP COLUMN INITIAL_EARNT_POINTS";
			IBQuery1->ExecQuery();
		}
