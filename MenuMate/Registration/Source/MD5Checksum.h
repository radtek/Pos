...
public:
	...
	AnsiString GetMD5(BYTE* pBuf, UINT nLength);
	AnsiString GetMD5(TMemoryStream *File);
	AnsiString GetMD5(const AnsiString Data);
//	AnsiString GetMD5(const AnsiString &strFilePath);
	CMD5Checksum();
