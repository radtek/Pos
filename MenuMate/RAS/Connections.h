...
typedef DWORD (__stdcall *TRasGetEntryProperties)(LPCSTR, LPCSTR, LPRASENTRYA, LPDWORD,LPBYTE, LPDWORD);
typedef DWORD (__stdcall *TRasSetEntryDialParams)(LPCSTR, LPRASDIALPARAMS, bool);
typedef DWORD (__stdcall *TRasEditPhonebookEntry)(HWND, LPCSTR, LPCSTR);
...
private:
   ...
   TRasGetEntryProperties RasGetEntryProperties;
   TRasSetEntryDialParams RasSetEntryDialParams;
   TRasEditPhonebookEntry RasEditPhonebookEntry;
public:
   ...
   AnsiString Password;
	HRASCONN   Handle;   
	void				Dial(AnsiString Entry, AnsiString &ErrorMsg);
	bool				HangUp();
