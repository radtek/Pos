...
extern PACKAGE TBaudRate __fastcall StrToBaudRate(System::UnicodeString Str);
extern PACKAGE TStopBits __fastcall StrToStopBits(System::UnicodeString Str);
extern PACKAGE TDataBits __fastcall StrToDataBits(System::UnicodeString Str);
extern PACKAGE TParityBits __fastcall StrToParity(System::UnicodeString Str);
extern PACKAGE TFlowControl __fastcall StrToFlowControl(System::UnicodeString Str);
extern PACKAGE System::UnicodeString __fastcall BaudRateToStr(TBaudRate BaudRate);
extern PACKAGE System::UnicodeString __fastcall StopBitsToStr(TStopBits StopBits);
extern PACKAGE System::UnicodeString __fastcall DataBitsToStr(TDataBits DataBits);
extern PACKAGE System::UnicodeString __fastcall ParityToStr(TParityBits Parity);
extern PACKAGE System::UnicodeString __fastcall FlowControlToStr(TFlowControl FlowControl);
