...
// (DO NOT EDIT: machine generated header) 'Cportesc.pas' rev: 21.00
...
public:
	...
	virtual System::UnicodeString __fastcall EscCodeToStr(TEscapeCode Code, Classes::TStrings* AParams) = 0 ;
	...
	__property System::WideChar Charachter = {read=FCharachter, nodefault};
...
public:
	...
	virtual System::UnicodeString __fastcall EscCodeToStr(TEscapeCode Code, Classes::TStrings* AParams);
public:
