...
// (DO NOT EDIT: machine generated header) 'TntMenus.pas' rev: 6.00
...
public:
	__fastcall virtual TTntMenuItem(Classes::TComponent* AOwner);
...
extern PACKAGE TTntMenuItem* __fastcall WideNewSubMenu(const WideString ACaption, Classes::THelpContext hCtx, const AnsiString AName, const TTntMenuItem* * Items, const int Items_Size, bool AEnabled);
...
extern PACKAGE WideString __fastcall WideShortCutToText(Classes::TShortCut ShortCut);
