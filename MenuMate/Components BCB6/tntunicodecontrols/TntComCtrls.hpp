...
// (DO NOT EDIT: machine generated header) 'TntComCtrls.pas' rev: 6.00
...
protected:
	...
	int __fastcall CharPosToGet(int CharPos);
	int __fastcall CharPosToSet(int CharPos);
...
protected:
	...
	virtual void __fastcall CreateWnd(void);
	virtual void __fastcall DestroyWnd(void);
	__property Tntclasses::TTntStrings* Tabs = {read=FTabs, write=SetTabs};
...
public:
	__fastcall virtual TTntCustomStatusBar(Classes::TComponent* AOwner);
...
public:
	#pragma option push -w-inl
	/* TTntCustomStatusBar.Create */ inline __fastcall virtual TTntStatusBar(Classes::TComponent* AOwner) : TTntCustomStatusBar(AOwner) { }
	#pragma option pop
...
private:
	...
	HIDESBASE void __fastcall WriteData(Classes::TStream* Stream, Comctrls::PNodeInfo Info);
...
private:
	...
	HIDESBASE void __fastcall WriteData(Classes::TStream* Stream);
