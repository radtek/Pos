...
// (DO NOT EDIT: machine generated header) 'TntDBGrids.pas' rev: 6.00
...
protected:
	virtual void __fastcall CreateWindowHandle(const Controls::TCreateParams &Params);
	HIDESBASEDYNAMIC void __fastcall ShowEditorChar(wchar_t Ch);
	virtual void __fastcall DefineProperties(Classes::TFiler* Filer);
...
public:
	__fastcall virtual TTntCustomDBGrid(Classes::TComponent* AOwner);
...
public:
	#pragma option push -w-inl
	/* TTntCustomDBGrid.Create */ inline __fastcall virtual TTntDBGrid(Classes::TComponent* AOwner) : TTntCustomDBGrid(AOwner) { }
	#pragma option pop
