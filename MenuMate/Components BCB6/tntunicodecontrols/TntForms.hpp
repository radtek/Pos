...
// (DO NOT EDIT: machine generated header) 'TntForms.pas' rev: 6.00
...
extern PACKAGE void __fastcall ConstructBaseClassForm(TTntForm* Self, TMetaClass* FormClass, Classes::TComponent* AOwner);
