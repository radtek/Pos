...
Name: Display_Dealer_Info; Description: Display &support information.; GroupDescription: Support Information
...
Source: ..\..\Static Files\HTML\de_search\ids.txt; DestDir: {app}\Html\de_search; AfterInstall: XeroIntegration_BeforeInstall;
Source: ..\..\Static Files\HTML\de_search\prefixes.txt; DestDir: {app}\Html\de_search; AfterInstall: BeforeInstall
...
Source: {#GetEnv('BASEDIR')}\Static Files\qtintf.dll; DestDir: {app}; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\UnzDLL.dll; DestDir: {app}; Flags: ignoreversion
...
Source: {#GetEnv('BASEDIR')}\MenuMate\Components BCB6\porttalk\porttalk.sys; DestDir: {app}; Flags: ignoreversion
...
Source: {#GetEnv('BASEDIR')}\Static Files\Palm\Add-On\BluetoothExt.prc; DestDir: {app}\Palm\Add-On; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\Palm\Add-On\BluetoothPnl.prc; DestDir: {app}\Palm\Add-On; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\Palm\Add-On\BtCommVdrv.prc; DestDir: {app}\Palm\Add-On; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\Palm\Add-On\BtLib.prc; DestDir: {app}\Palm\Add-On; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\Palm\Add-On\BtStackLib.prc; DestDir: {app}\Palm\Add-On; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\Palm\Add-On\BtTransportSDLib.prc; DestDir: {app}\Palm\Add-On; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\vncviewer.exe; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\vncviewer.tight.exe; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\WinVNC.exe; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\winvnc.real.exe; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\winvnc.tight.exe; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\wm_hooks.dll; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\vncconfig.exe; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\logmessages.dll; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\wm_hooks.dll; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\zipdll.dll; DestDir: {app}\help; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\help\General Public Licence.txt; DestDir: {app}\help; Flags: ignoreversion

Source: {#GetEnv('BASEDIR')}\Static Files\kiosk\index.html; DestDir: {app}\kiosk; Flags: ignoreversion onlyifdoesntexist
...
Source: {#GetEnv('BASEDIR')}\Static Files\kiosk\indexFinancial.html; DestDir: {app}\kiosk; Flags: ignoreversion onlyifdoesntexist
...
Source: {#GetEnv('BASEDIR')}\Static Files\summaIdMap.xml; DestDir: {app}; Flags: ignoreversion onlyifdoesntexist
Source: {#GetEnv('BASEDIR')}\Static Files\summaSettings.xml; DestDir: {app}; Flags: ignoreversion onlyifdoesntexist
...
; Firebird / FlameRobin distribution.

Source: {#GetEnv('BASEDIR')}\Static Files\Firebird\Firebird-2.5.0.26074_1_Win32.exe; DestDir: {app}\Firebird; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\Firebird\Firebird-2.5.0.26074_1_x64.exe; DestDir: {app}\Firebird; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\Firebird\flamerobin-0.9.2-1-setup.exe; DestDir: {app}\Firebird; Flags: ignoreversion
Source: {#GetEnv('BASEDIR')}\Static Files\Firebird\flamerobin-0.9.2-1-setup-x64.exe; DestDir: {app}\Firebird; Flags: ignoreversion
...
Source: {#GetEnv('BASEDIR')}\MenuMate\Services\Menumate.Services\bin\Release\Menumate.WinServices.Contracts.pdb ; BeforeInstall: BeforeInstall; DestDir: {app}\Floorplan\Service ; Flags:ignoreversion;
...
Source: "{#GetEnv('BASEDIR')}\Menumate\Services\ServicesApp\Ready for Distribution\MenumateServices.exe.config"; DestDir: "{app}\Menumate Services\"; Flags: ignoreversion;
Source: "{#GetEnv('BASEDIR')}\Menumate\Services\ServicesApp\Ready for Distribution\MenumateUtils.dll";           DestDir: "{app}\Menumate Services\"; Flags: ignoreversion; AfterInstall: AfterInstall;
...
Source: "{#GetEnv('BASEDIR')}\Menumate\Services\ServicesApp\Ready for Distribution\AustriaFiscalIntegration.dll";            DestDir: "{app}\Menumate Services\"; 
Flags: ignoreversion;
...
Root: HKLM; Subkey: Software\IQWORKS\MenuMate\Database; ValueType: string; ValueName: BroadCastIP; ValueData: 192.168.0.255; Flags: createvalueifdoesntexist uninsdeletevalue

[Icons]
Name: {group}\MenuMate; Filename: {app}\MenuMate.exe; IconIndex: 0; Flags: createonlyiffileexists; WorkingDir: {app}
...
[Run]
Filename: {app}\Firebird\Firebird-2.5.0.26074_1_Win32.exe; Tasks:
...
[_ISToolPreCompile]
Name: C:\Users\michael\dev\5.Win7\Build\MachineEnviroment.bat; Parameters:
...
begin
  ...
  Exec(ServicePath, '--install', '', SW_SHOW, ewWaitUntilTerminated,
       ResultCode);
  Exec(ServicePath, '--start', '', SW_SHOW, ewWaitUntilTerminated,
       ResultCode);
end;
