...
enum TVirtualNodeState { vsInitialized, vsChecking, vsCutOrCopy, vsDisabled, vsDeleting, vsExpanded, vsHasChildren, vsVisible, vsSelected, vsInitialUserData, vsAllChildrenHidden, vsClearing, vsMultiline, vsHeightMeasured };
#pragma option pop

typedef Set<TVirtualNodeState, vsInitialized, vsHeightMeasured>  TVirtualNodeStates;
...
#pragma option push -b-
enum TVTColumnOption { coAllowClick, coDraggable, coEnabled, coParentBidiMode, coParentColor, coResizable, coShowDropMark, coVisible, coAutoSpring };
#pragma option pop

typedef Set<TVTColumnOption, coAllowClick, coAutoSpring>  TVTColumnOptions;
...
#pragma option push -b-
enum TVTPaintOption { toHideFocusRect, toHideSelection, toHotTrack, toPopupMode, toShowBackground, toShowButtons, toShowDropmark, toShowHorzGridLines, toShowRoot, toShowTreeLines, toShowVertGridLines, toThemeAware, toUseBlendedImages, toGhostedIfUnfocused, toFullVertGridLines, toAlwaysHideSelection, toUseBlendedSelection };
#pragma option pop

typedef Set<TVTPaintOption, toHideFocusRect, toUseBlendedSelection>  TVTPaintOptions;
...
#pragma option push -b-
enum TVTAutoOption { toAutoDropExpand, toAutoExpand, toAutoScroll, toAutoScrollOnExpand, toAutoSort, toAutoSpanColumns, toAutoTristateTracking, toAutoHideButtons, toAutoDeleteMovedNodes, toDisableAutoscrollOnFocus, toAutoChangeScale, toAutoFreeOnCollapse };
#pragma option pop

typedef Set<TVTAutoOption, toAutoDropExpand, toAutoFreeOnCollapse>  TVTAutoOptions;
...
public:
	...
	virtual void __fastcall PaintHeader(HDC DC, const Types::TRect &R, int HOffset, int VOffset = 0x0);
...
#pragma option push -b-
enum TVTImageInfoIndex { iiNormal, iiState, iiCheck };
#pragma option pop
...
protected:
	...
	void __fastcall AddToSelection(const TNodeArray NewItems, int NewLength, bool ForceInsert = false)/* overload */;
	virtual void __fastcall AdjustPaintCellRect(TVTPaintInfo &PaintInfo, TColumnIndex &NextNonEmpty);
	void __fastcall AdjustPanningCursor(int X, int Y);
	void __fastcall AdviseChangeEvent(bool StructureChange, PVirtualNode Node, TChangeReason Reason);
	unsigned __fastcall AllocateInternalDataArea(unsigned Size);
	void __fastcall Animate(unsigned Steps, unsigned Duration, TVTAnimationCallback Callback, void * Data);
	bool __fastcall CalculateSelectionRect(int X, int Y);
	...
	void __fastcall Change(PVirtualNode Node);
	DYNAMIC void __fastcall ChangeScale(int M, int D);
	bool __fastcall CheckParentCheckState(PVirtualNode Node, TCheckState NewCheckState);
	void __fastcall ClearTempCache(void);
	virtual bool __fastcall ColumnIsEmpty(PVirtualNode Node, TColumnIndex Column);
	int __fastcall CountLevelDifference(PVirtualNode Node1, PVirtualNode Node2);
	unsigned __fastcall CountVisibleChildren(PVirtualNode Node);
	virtual void __fastcall CreateParams(Controls::TCreateParams &Params);
	virtual void __fastcall CreateWnd(void);
	virtual void __fastcall DefineProperties(Classes::TFiler* Filer);
	void __fastcall DetermineHiddenChildrenFlag(PVirtualNode Node);
	void __fastcall DetermineHiddenChildrenFlagAllNodes(void);
	...
	TScrollDirections __fastcall DetermineScrollDirections(int X, int Y);
	...
	void __fastcall DoDragExpand(void);
	...
	virtual void __fastcall DoGetImageIndex(PVirtualNode Node, TVTImageKind Kind, TColumnIndex Column, bool &Ghosted, int &Index);
	virtual void __fastcall DoGetLineStyle(void * &Bits);
	virtual WideString __fastcall DoGetNodeHint(PVirtualNode Node, TColumnIndex Column);
	virtual WideString __fastcall DoGetNodeTooltip(PVirtualNode Node, TColumnIndex Column);
	...
	virtual void __fastcall DoStateChange(const TVirtualTreeStates &Enter, const TVirtualTreeStates &Leave = System::Set<VirtualTrees__61, tsCancelHintAnimation, tsWindowCreating> () );
	virtual void __fastcall DoStructureChange(PVirtualNode Node, TChangeReason Reason);
	void __fastcall DoTimerScroll(void);
	virtual void __fastcall DoUpdating(TVTUpdateState State);
	bool __fastcall DoValidateCache(void);
	...
	void __fastcall DrawDottedHLine(const TVTPaintInfo &PaintInfo, int Left, int Right, int Top);
	void __fastcall DrawDottedVLine(const TVTPaintInfo &PaintInfo, int Top, int Bottom, int Left);
	bool __fastcall FindNodeInSelection(PVirtualNode P, int &Index, int LowBound, int HighBound);
	void __fastcall FinishChunkHeader(Classes::TStream* Stream, int StartPos, int EndPos);
	HIDESBASE void __fastcall FontChanged(System::TObject* AFont);
	...
	int __fastcall GetImageIndex(PVirtualNode Node, TVTImageKind Kind, TColumnIndex Column, bool &Ghosted);
	unsigned __fastcall GetMaxRightExtend(void);
	...
	TBaseVirtualTree* __fastcall GetTreeFromDataObject(const _di_IDataObject DataObject);
	void __fastcall HandleHotTrack(int X, int Y);
	void __fastcall HandleIncrementalSearch(Word CharCode);
	void __fastcall HandleMouseDblClick(Messages::TWMMouse &Message, const THitInfo &HitInfo);
	void __fastcall HandleMouseDown(Messages::TWMMouse &Message, const THitInfo &HitInfo);
	void __fastcall HandleMouseUp(Messages::TWMMouse &Message, const THitInfo &HitInfo);
	virtual bool __fastcall HasPopupMenu(PVirtualNode Node, TColumnIndex Column, const Types::TPoint &Pos);
	void __fastcall InitChildren(PVirtualNode Node);
	void __fastcall InitNode(PVirtualNode Node);
	void __fastcall InternalAddFromStream(Classes::TStream* Stream, int Version, PVirtualNode Node);
	...
	void __fastcall InternalCacheNode(PVirtualNode Node);
	void __fastcall InternalClearSelection(void);
	void __fastcall InternalConnectNode(PVirtualNode Node, PVirtualNode Destination, TBaseVirtualTree* Target, TVTNodeAttachMode Mode);
	void * __fastcall InternalData(PVirtualNode Node);
	void __fastcall InternalDisconnectNode(PVirtualNode Node, bool KeepFocus, bool Reindex = true);
	void __fastcall InternalRemoveFromSelection(PVirtualNode Node);
	void __fastcall InvalidateCache(void);
	virtual void __fastcall Loaded(void);
	virtual void __fastcall MainColumnChanged(void);
	void __fastcall MarkCutCopyNodes(void);
	DYNAMIC void __fastcall MouseMove(Classes::TShiftState Shift, int X, int Y);
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation Operation);
	void __fastcall OriginalWMNCPaint(HDC DC);
	virtual void __fastcall Paint(void);
	virtual void __fastcall PaintCheckImage(const TVTPaintInfo &PaintInfo);
	virtual void __fastcall PaintImage(const TVTPaintInfo &PaintInfo, TVTImageInfoIndex ImageInfoIndex, Imglist::TCustomImageList* Images, bool DoOverlay);
	...
	void __fastcall PaintSelectionRectangle(Graphics::TCanvas* Target, int WindowOrgX, const Types::TRect &SelectionRect, const Types::TRect &TargetRect);
	void __fastcall PanningWindowProc(Messages::TMessage &Message);
	...
	void __fastcall RedirectFontChangeEvent(Graphics::TCanvas* Canvas);
	void __fastcall RemoveFromSelection(PVirtualNode Node);
	virtual HRESULT __fastcall RenderOLEData(const tagFORMATETC &FormatEtcIn, /* out */ tagSTGMEDIUM &Medium, bool ForClipboard);
	void __fastcall ResetRangeAnchor(void);
	void __fastcall RestoreFontChangeEvent(Graphics::TCanvas* Canvas);
	void __fastcall SelectNodes(PVirtualNode StartNode, PVirtualNode EndNode, bool AddOnly);
	virtual void __fastcall SetBiDiMode(Classes::TBiDiMode Value);
	void __fastcall SetFocusedNodeAndColumn(PVirtualNode Node, TColumnIndex Column);
	virtual void __fastcall SkipNode(Classes::TStream* Stream);
	void __fastcall StartWheelPanning(const Types::TPoint &Position);
	void __fastcall StopWheelPanning(void);
	void __fastcall StructureChange(PVirtualNode Node, TChangeReason Reason);
	...
	void __fastcall ToggleSelection(PVirtualNode StartNode, PVirtualNode EndNode);
	void __fastcall UnselectNodes(PVirtualNode StartNode, PVirtualNode EndNode);
	void __fastcall UpdateDesigner(void);
	void __fastcall UpdateEditBounds(void);
	void __fastcall UpdateHeaderRect(void);
	void __fastcall UpdateWindowAndDragImage(const TBaseVirtualTree* Tree, const Types::TRect &TreeRect, bool UpdateNCArea, bool ReshowDragImage);
	void __fastcall ValidateCache(void);
	...
	void __fastcall WriteNode(Classes::TStream* Stream, PVirtualNode Node);
...
public:
	...
	PVirtualNode __fastcall IterateSubtree(PVirtualNode Node, TVTGetNodeProc Callback, void * Data, TVirtualNodeStates Filter = System::Set<TVirtualNodeState, vsInitialized, vsHeightMeasured> () , bool DoInit = false, bool ChildNodesOnly = false);
...
protected:
	...
	__property TVSTGetTextEvent OnGetHint = {read=FOnGetHint, write=FOnGetHint};
...
public:
	...
	virtual int __fastcall ComputeNodeHeight(Graphics::TCanvas* Canvas, PVirtualNode Node, TColumnIndex Column);
	...
	WideString __fastcall ContentToUnicode(TVSTTextSourceType Source, wchar_t Separator);
	virtual Types::TRect __fastcall InvalidateNode(PVirtualNode Node);
...
static const Controls::TCursor crHeaderSplit = 0x64;
...
#define DefaultPaintOptions (System::Set<TVTPaintOption, toHideFocusRect, toUseBlendedSelection> () << TVTPaintOption(5) << TVTPaintOption(6) << TVTPaintOption(8) << TVTPaintOption(9) << TVTPaintOption(11) << TVTPaintOption(12) )
#define DefaultAnimationOptions EMPTYSET
#define DefaultAutoOptions (System::Set<TVTAutoOption, toAutoDropExpand, toAutoFreeOnCollapse> () << TVTAutoOption(0) << TVTAutoOption(3) << TVTAutoOption(6) << TVTAutoOption(8) )
#define DefaultSelectionOptions EMPTYSET
#define DefaultMiscOptions (System::Set<TVTMiscOption, toAcceptOLEDrop, toFullRowDrag> () << TVTMiscOption(0) << TVTMiscOption(3) << TVTMiscOption(5) << TVTMiscOption(7) << TVTMiscOption(8) )
#define DefaultColumnOptions (System::Set<TVTColumnOption, coAllowClick, coAutoSpring> () << TVTColumnOption(0) << TVTColumnOption(1) << TVTColumnOption(2) << TVTColumnOption(3) << TVTColumnOption(4) << TVTColumnOption(5) << TVTColumnOption(6) << TVTColumnOption(7) )
