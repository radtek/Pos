...
protected:
	...
	void __fastcall RemoveRecreationCandiate(Controls::TControl* Control);
...
__published:
	__property TThemeOptions Options = {read=FOptions, write=SetThemeOptions, default=262135};
