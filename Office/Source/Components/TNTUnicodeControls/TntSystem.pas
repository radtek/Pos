...
var
  CustomLoadResStringW: function(ResStringRec: PResStringRec; var Value: WideString): Boolean;
...
type
  TTntSystemUpdate = (tsWideResourceStrings, tsFixImplicitCodePage, tsFixWideStrConcat);
...
var
  ...
  PCustom: PAnsiChar;
begin
  if Assigned(CustomLoadResStringW) and CustomLoadResStringW(ResStringRec, Result) then
...
begin
  ...
  if CodeMatchesPatternForUnicode(ReturnAddr) then begin
    ...
    LastWideResString := LoadResStringW(ResStringRec);
...
var
  ...
  System_WStrCat3_Code: TOverwrittenData;
