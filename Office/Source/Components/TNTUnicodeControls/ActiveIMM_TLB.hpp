...
// (DO NOT EDIT: machine generated header) 'ActiveIMM_TLB.pas' rev: 6.00
...
public:
	virtual HRESULT __stdcall RegisterIME(GUID &rclsid, Word lgid, wchar_t * pszIconFile, wchar_t * pszDesc) = 0 ;
...
public:
	...
	virtual HRESULT __stdcall EnumRegisterWordW(void * &hKL, wchar_t * szReading, unsigned dwStyle, wchar_t * szRegister, void * &pData, /* out */ _di_IEnumRegisterWordW &pEnum) = 0 ;
	...
	virtual HRESULT __stdcall GetConversionListW(void * &hKL, unsigned hIMC, wchar_t * pSrc, unsigned uBufLen, unsigned uFlag, /* out */ __MIDL___MIDL_itf_dimm_0000_0007 &pDst, /* out */ unsigned &puCopied) = 0 ;
	...
	virtual HRESULT __stdcall GetDescriptionW(void * &hKL, unsigned uBufLen, wchar_t * szDescription, /* out */ unsigned &puCopied) = 0 ;
	...
	virtual HRESULT __stdcall GetGuideLineW(unsigned hIMC, unsigned dwIndex, unsigned dwBufLen, wchar_t * pBuf, /* out */ unsigned &pdwResult) = 0 ;
	virtual HRESULT __stdcall GetIMEFileNameA(void * &hKL, unsigned uBufLen, char * szFileName, /* out */ unsigned &puCopied) = 0 ;
	virtual HRESULT __stdcall GetIMEFileNameW(void * &hKL, unsigned uBufLen, wchar_t * szFileName, /* out */ unsigned &puCopied) = 0 ;
	...
	virtual HRESULT __stdcall InstallIMEW(wchar_t * szIMEFileName, wchar_t * szLayoutText, /* out */ void * &phKL) = 0 ;
	...
	virtual HRESULT __stdcall REGISTERWORDW(void * &hKL, wchar_t * szReading, unsigned dwStyle, wchar_t * szRegister) = 0 ;
	...
	virtual HRESULT __stdcall UnregisterWordW(void * &hKL, wchar_t * szReading, unsigned dwStyle, wchar_t * szUnregister) = 0 ;
...
public:
	virtual HRESULT __stdcall Inquire(unsigned dwSystemInfoFlags, /* out */ __MIDL___MIDL_itf_dimm_0000_0014 &pIMEInfo, wchar_t * szWndClass, /* out */ unsigned &pdwPrivate) = 0 ;
	virtual HRESULT __stdcall ConversionList(unsigned hIMC, wchar_t * szSource, unsigned uFlag, unsigned uBufLen, /* out */ __MIDL___MIDL_itf_dimm_0000_0007 &pDest, /* out */ unsigned &puCopied) = 0 ;
	...
	virtual HRESULT __stdcall RegisterWord(wchar_t * szReading, unsigned dwStyle, wchar_t * szString) = 0 ;
	virtual HRESULT __stdcall UnregisterWord(wchar_t * szReading, unsigned dwStyle, wchar_t * szString) = 0 ;
	...
	virtual HRESULT __stdcall EnumRegisterWord(wchar_t * szReading, unsigned dwStyle, wchar_t * szRegister, void * &pData, /* out */ _di_IEnumRegisterWordW &ppEnum) = 0 ;
...
public:
	...
	HRESULT __fastcall EnumRegisterWordW(void * &hKL, wchar_t * szReading, unsigned dwStyle, wchar_t * szRegister, void * &pData, /* out */ _di_IEnumRegisterWordW &pEnum);
	...
	HRESULT __fastcall GetConversionListW(void * &hKL, unsigned hIMC, wchar_t * pSrc, unsigned uBufLen, unsigned uFlag, /* out */ __MIDL___MIDL_itf_dimm_0000_0007 &pDst, /* out */ unsigned &puCopied);
	...
	HRESULT __fastcall GetDescriptionW(void * &hKL, unsigned uBufLen, wchar_t * szDescription, /* out */ unsigned &puCopied);
	HRESULT __fastcall GetGuideLineA(unsigned hIMC, unsigned dwIndex, unsigned dwBufLen, char * pBuf, /* out */ unsigned &pdwResult);
	HRESULT __fastcall GetGuideLineW(unsigned hIMC, unsigned dwIndex, unsigned dwBufLen, wchar_t * pBuf, /* out */ unsigned &pdwResult);
	HRESULT __fastcall GetIMEFileNameA(void * &hKL, unsigned uBufLen, char * szFileName, /* out */ unsigned &puCopied);
	HRESULT __fastcall GetIMEFileNameW(void * &hKL, unsigned uBufLen, wchar_t * szFileName, /* out */ unsigned &puCopied);
	...
	HRESULT __fastcall InstallIMEW(wchar_t * szIMEFileName, wchar_t * szLayoutText, /* out */ void * &phKL);
	...
	HRESULT __fastcall REGISTERWORDW(void * &hKL, wchar_t * szReading, unsigned dwStyle, wchar_t * szRegister);
	...
	HRESULT __fastcall UnregisterWordW(void * &hKL, wchar_t * szReading, unsigned dwStyle, wchar_t * szUnregister);
