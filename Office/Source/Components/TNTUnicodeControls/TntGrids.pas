...
{TNT-WARN TStringGrid}
  ...
  private
    ...
    function FindGridStrings(IsCol: Boolean; ListIndex: Integer): TTntStrings;
...
function TTntStringGrid.FindGridStrings(IsCol: Boolean; ListIndex: Integer): TTntStrings;
var
  idx: integer;
