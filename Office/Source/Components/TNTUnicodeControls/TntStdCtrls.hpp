...
// (DO NOT EDIT: machine generated header) 'TntStdCtrls.pas' rev: 6.00
...
protected:
	Stdctrls::TCustomMemo* Memo;
	bool FRichEditMode;
	Tntsysutils::TTntTextLineBreakStyle LineBreakStyle;
...
private:
	...
	HIDESBASE void __fastcall SetLines(const Tntclasses::TTntStrings* Value);
	HIDESBASE void __fastcall SetSelText(const WideString Value);
	HIDESBASE WideString __fastcall GetText();
	HIDESBASE void __fastcall SetText(const WideString Value);
	WideString __fastcall GetHint();
...
private:
	...
	void __fastcall SetHint(const WideString Value);
	HIDESBASE bool __fastcall IsHintStored(void);
	bool __fastcall GetOwnerData(int Index, /* out */ WideString &Data);
...
public:
	#pragma option push -w-inl
	/* TCustomStaticText.Create */ inline __fastcall virtual TTntCustomStaticText(Classes::TComponent* AOwner) : Stdctrls::TCustomStaticText(AOwner) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TCustomStaticText.Create */ inline __fastcall virtual TTntStaticText(Classes::TComponent* AOwner) : TTntCustomStaticText(AOwner) { }
	#pragma option pop
...
extern PACKAGE void __fastcall TntCustomEdit_AfterInherited_CreateWnd(Stdctrls::TCustomEdit* Edit, wchar_t &FPasswordChar);
...
extern PACKAGE WideString __fastcall TntCustomEdit_GetPasswordChar(Stdctrls::TCustomEdit* Edit, wchar_t &FPasswordChar);
extern PACKAGE void __fastcall TntCustomEdit_SetPasswordChar(Stdctrls::TCustomEdit* Edit, wchar_t &FPasswordChar, const WideString Value);
extern PACKAGE int __fastcall TntMemo_LineStart(unsigned Handle, int Index);
extern PACKAGE int __fastcall TntMemo_LineLength(unsigned Handle, int Index);
...
extern PACKAGE void __fastcall TntCombo_BeforeInherited_DestroyWnd(Stdctrls::TCustomComboBox* Combo, Tntclasses::TTntStrings* Items, Tntclasses::TTntStrings* &FSaveItems, int ItemIndex, int &FSaveItemIndex);
