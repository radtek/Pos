...
class PASCALIMPLEMENTATION TTntHintWindow : public Controls::THintWindow 
{
...
public:
	...
	/* THintWindow.Create */ inline __fastcall virtual TTntHintWindow(Classes::TComponent* AOwner) : Controls::THintWindow(AOwner) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TTntHintWindow(HWND ParentWindow) : Controls::THintWindow(ParentWindow) { }
	#pragma option pop
