...
//---------------------------------------------------------------------------
AnsiString __fastcall TTouchBtn::GetCaption()
{
	return FButtons[0]->Caption;
}
//---------------------------------------------------------------------------
void __fastcall TTouchBtn::SetCaption(AnsiString Caption)
{
...
//---------------------------------------------------------------------------
void __fastcall TTouchBtn::SetArrowType(TArrowType Value)
{
	FArrowType = Value;
	Invalidate();
}
