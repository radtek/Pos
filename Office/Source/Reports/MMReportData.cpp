	 ...
	 qrSalesSummaryD->SQL->Text =
        ...
        "Select "
           ...
           "ZEDS.TIME_STAMP,  "
            ...
            "SUM(CASE When ARCHIVENew.price=0  Then CANCEL_AMOUNT.CANCEL_TOTAL Else 0 End ) AS VOID_AMOUNT, "
         ...
         "LEFT JOIN ( "
          ...
          "LEFT JOIN ( "
           ...
           " LEFT JOIN  ( "
                                ...
                                "LEFT JOIN ZEDS ON ZEDS.Z_KEY=ARCBILL.Z_KEY "
                                "WHERE ZEDS.Time_Stamp >= :StartTime and ZEDS.Time_Stamp < :EndTime "
                                " GROUP BY ARCBILL.Z_KEY,a.DISCOUNT_GROUPNAME) discountsection GROUP BY discountsection.Z_KEY "
