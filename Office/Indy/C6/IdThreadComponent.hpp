...
// (DO NOT EDIT: machine generated header) 'IdThreadComponent.pas' rev: 6.00
...
typedef void __fastcall (__closure *TIdExceptionThreadComponentEvent)(TIdCustomThreadComponent* Sender, Sysutils::Exception* AException);
...
public:
	...
	void __fastcall Synchronize(const System::TMethod &AMethod)/* overload */;
...
public:
	...
	/* TIdCustomThreadComponent.Create */ inline __fastcall virtual TIdThreadComponent(Classes::TComponent* AOwner) : TIdCustomThreadComponent(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
