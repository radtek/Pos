...
// (DO NOT EDIT: machine generated header) 'IdAuthenticationManager.pas' rev: 6.00
...
public:
	...
	void __fastcall AddAuthentication(Idauthentication::TIdAuthentication* AAuthtetication, Iduri::TIdURI* AURL);
