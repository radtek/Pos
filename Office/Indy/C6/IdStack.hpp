...
public:
	...
	bool __fastcall GetIPInfo(const AnsiString AIP, System::PByte VB1 = (void *)(0x0), System::PByte VB2 = (void *)(0x0), System::PByte VB3 = (void *)(0x0), System::PByte VB4 = (void *)(0x0), PIdIPType VType = (void *)(0x0), PIdIPClass VClass = (void *)(0x0));
	...
	bool __fastcall IPIsClass(const AnsiString AIP, const TIdIPClass * AClasses, const int AClasses_Size)/* overload */;
	...
	virtual int __fastcall WSGetSockOpt(int ASocket, int Alevel, int AOptname, char * AOptval, int &AOptlen) = 0 ;
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdInvalidIPAddress(const AnsiString Msg) : EIdStackError(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdInvalidIPAddress(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EIdStackError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdInvalidIPAddress(int Ident)/* overload */ : EIdStackError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdInvalidIPAddress(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EIdStackError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdInvalidIPAddress(const AnsiString Msg, int AHelpContext) : EIdStackError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdInvalidIPAddress(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EIdStackError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EIdInvalidIPAddress(int Ident, int AHelpContext)/* overload */ : EIdStackError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdInvalidIPAddress(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EIdStackError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
