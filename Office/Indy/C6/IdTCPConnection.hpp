...
protected:
	...
	void __fastcall PerformCapture(System::TObject* ADest, /* out */ int &VLineCount, const AnsiString ADelim, const bool AIsRFCMessage);
	virtual void __fastcall ResetConnection(void);
	void __fastcall SetGreeting(Idrfcreply::TIdRFCReply* AValue);
...
public:
	...
	void __fastcall Capture(Classes::TStream* ADest, const AnsiString ADelim = ".", const bool AIsRFCMessage = true)/* overload */;
	void __fastcall Capture(Classes::TStream* ADest, /* out */ int &VLineCount, const AnsiString ADelim = ".", const bool AIsRFCMessage = true)/* overload */;
	void __fastcall Capture(Classes::TStrings* ADest, const AnsiString ADelim = ".", const bool AIsRFCMessage = true)/* overload */;
	void __fastcall Capture(Classes::TStrings* ADest, /* out */ int &VLineCount, const AnsiString ADelim = ".", const bool AIsRFCMessage = true)/* overload */;
	...
	__property Idrfcreply::TIdRFCReply* Greeting = {read=FGreeting, write=SetGreeting};
	AnsiString __fastcall InputLn(const AnsiString AMask = "", bool AEcho = true, int ATabWidth = 0x8, int AMaxLineLength = 0xffffffff);
	...
	virtual int __fastcall ReadFromStack(const bool ARaiseExceptionIfDisconnected = true, int ATimeout = 0xffffffff, const bool ARaiseExceptionOnTimeout = true);
	int __fastcall ReadInteger(const bool AConvert = true);
	virtual AnsiString __fastcall ReadLn(AnsiString ATerminator = "\n", const int ATimeout = 0xffffffff, int AMaxLineLength = 0xffffffff);
	AnsiString __fastcall ReadLnWait(int AFailCount = 0x7fffffff);
	...
	virtual void __fastcall WriteStream(Classes::TStream* AStream, const bool AAll = true, const bool AWriteByteCount = false, const int ASize = 0x0);
	void __fastcall WriteStrings(Classes::TStrings* AValue, const bool AWriteLinesCount = false);
	virtual unsigned __fastcall WriteFile(const AnsiString AFile, const bool AEnableTransferFile = false);
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdIOHandlerPropInvalid(const AnsiString Msg) : EIdTCPConnectionError(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdIOHandlerPropInvalid(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EIdTCPConnectionError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdIOHandlerPropInvalid(int Ident)/* overload */ : EIdTCPConnectionError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdIOHandlerPropInvalid(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EIdTCPConnectionError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdIOHandlerPropInvalid(const AnsiString Msg, int AHelpContext) : EIdTCPConnectionError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdIOHandlerPropInvalid(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EIdTCPConnectionError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdIOHandlerPropInvalid(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EIdTCPConnectionError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdNotConnected(const AnsiString Msg) : EIdTCPConnectionError(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdNotConnected(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EIdTCPConnectionError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdNotConnected(int Ident)/* overload */ : EIdTCPConnectionError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdNotConnected(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EIdTCPConnectionError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdNotConnected(const AnsiString Msg, int AHelpContext) : EIdTCPConnectionError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdNotConnected(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EIdTCPConnectionError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EIdNotConnected(int Ident, int AHelpContext)/* overload */ : EIdTCPConnectionError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdNotConnected(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EIdTCPConnectionError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdFileNotFound(const AnsiString Msg) : EIdTCPConnectionError(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdFileNotFound(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EIdTCPConnectionError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdFileNotFound(int Ident)/* overload */ : EIdTCPConnectionError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdFileNotFound(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EIdTCPConnectionError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdFileNotFound(const AnsiString Msg, int AHelpContext) : EIdTCPConnectionError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdFileNotFound(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EIdTCPConnectionError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdFileNotFound(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EIdTCPConnectionError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
