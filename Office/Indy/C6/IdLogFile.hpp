...
// (DO NOT EDIT: machine generated header) 'IdLogFile.pas' rev: 6.00
...
protected:
	...
	virtual void __fastcall LogFormat(const AnsiString AFormat, const System::TVarRec * AArgs, const int AArgs_Size);
...
public:
	...
	/* TIdLogBase.Create */ inline __fastcall virtual TIdLogFile(Classes::TComponent* AOwner) : Idlogbase::TIdLogBase(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
