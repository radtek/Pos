...
// (DO NOT EDIT: machine generated header) 'IdCoderHeader.pas' rev: 6.00
...
extern PACKAGE void __fastcall InitializeISO(TTransfer &TransferHeader, char &HeaderEncoding, AnsiString &CharSet);
