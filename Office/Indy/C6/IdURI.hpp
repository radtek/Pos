...
public:
	...
	AnsiString __fastcall GetFullURI(const TIdURIOptionalFieldsSet AOptionalFileds = (System::Set<TIdURIOptionalFields, ofAuthInfo, ofBookmark> () << TIdURIOptionalFields(0) << TIdURIOptionalFields(1) ));
	...
	/*         class method */ static AnsiString __fastcall URLEncode(TMetaClass* vmt, const AnsiString ASrc);
	/*         class method */ static AnsiString __fastcall ParamsEncode(TMetaClass* vmt, const AnsiString ASrc);
	/*         class method */ static AnsiString __fastcall PathEncode(TMetaClass* vmt, const AnsiString ASrc);
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdURIException(const AnsiString Msg) : Idexception::EIdException(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdURIException(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : Idexception::EIdException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdURIException(int Ident)/* overload */ : Idexception::EIdException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdURIException(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : Idexception::EIdException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdURIException(const AnsiString Msg, int AHelpContext) : Idexception::EIdException(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdURIException(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : Idexception::EIdException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdURIException(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Idexception::EIdException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
