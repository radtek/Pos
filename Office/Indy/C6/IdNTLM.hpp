...
// (DO NOT EDIT: machine generated header) 'IdNTLM.pas' rev: 6.00
...
extern PACKAGE AnsiString __fastcall BuildType3Message(WideString ADomain, WideString AHost, WideString AUsername, AnsiString APassword, AnsiString ANonce);
