...
// (DO NOT EDIT: machine generated header) 'IdMessageCoderUUE.pas' rev: 6.00
...
public:
	...
	/* TIdMessageDecoder.Create */ inline __fastcall virtual TIdMessageDecoderUUE(Classes::TComponent* AOwner) : Idmessagecoder::TIdMessageDecoder(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TIdMessageEncoder.Create */ inline __fastcall virtual TIdMessageEncoderUUEBase(Classes::TComponent* AOwner) : Idmessagecoder::TIdMessageEncoder(AOwner) { }
	#pragma option pop
