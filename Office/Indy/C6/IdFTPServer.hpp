...
// (DO NOT EDIT: machine generated header) 'IdFTPServer.pas' rev: 6.00
...
typedef void __fastcall (__closure *TOnUserLoginEvent)(TIdFTPServerThread* ASender, const AnsiString AUsername, const AnsiString APassword, bool &AAuthenticated);
...
typedef void __fastcall (__closure *TOnGetFileSizeEvent)(TIdFTPServerThread* ASender, const AnsiString AFilename, __int64 &VFileSize);

typedef void __fastcall (__closure *TOnListDirectoryEvent)(TIdFTPServerThread* ASender, const AnsiString APath, Idftplist::TIdFTPListItems* ADirectoryListing);

typedef void __fastcall (__closure *TOnFileEvent)(TIdFTPServerThread* ASender, const AnsiString APathName);

typedef void __fastcall (__closure *TOnRenameFileEvent)(TIdFTPServerThread* ASender, const AnsiString ARenameFromFile, const AnsiString ARenameToFile);

typedef void __fastcall (__closure *TOnRetrieveFileEvent)(TIdFTPServerThread* ASender, const AnsiString AFileName, Classes::TStream* &VStream);

typedef void __fastcall (__closure *TOnStoreFileEvent)(TIdFTPServerThread* ASender, const AnsiString AFileName, bool AAppend, Classes::TStream* &VStream);

typedef void __fastcall (__closure *TOnPASVEvent)(TIdFTPServerThread* ASender, AnsiString &VIP, Word &VPort);
...
public:
	...
	/* Exception.Create */ inline __fastcall EIdFTPServerException(const AnsiString Msg) : Idexception::EIdException(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdFTPServerException(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : Idexception::EIdException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdFTPServerException(int Ident)/* overload */ : Idexception::EIdException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdFTPServerException(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : Idexception::EIdException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdFTPServerException(const AnsiString Msg, int AHelpContext) : Idexception::EIdException(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdFTPServerException(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : Idexception::EIdException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdFTPServerException(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Idexception::EIdException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdFTPServerNoOnListDirectory(const AnsiString Msg) : EIdFTPServerException(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdFTPServerNoOnListDirectory(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EIdFTPServerException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdFTPServerNoOnListDirectory(int Ident)/* overload */ : EIdFTPServerException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdFTPServerNoOnListDirectory(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EIdFTPServerException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdFTPServerNoOnListDirectory(const AnsiString Msg, int AHelpContext) : EIdFTPServerException(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdFTPServerNoOnListDirectory(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EIdFTPServerException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdFTPServerNoOnListDirectory(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EIdFTPServerException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	__fastcall virtual TIdFTPServerThread(bool ACreateSuspended);
	...
	__property int DataPort = {read=FDataPort, nodefault};
...
typedef void __fastcall (__closure *TIdOnGetCustomListFormat)(TIdFTPServer* ASender, Idftplist::TIdFTPListItem* AItem, AnsiString &VText);
...
protected:
	...
	void __fastcall DoOnPASV(TIdFTPServerThread* AThread, AnsiString &VIP, Word &VPort);
	virtual void __fastcall InitializeCommandHandlers(void);
	void __fastcall ListDirectory(TIdFTPServerThread* ASender, AnsiString ADirectory, Classes::TStringList* &ADirContents, bool ADetails);
...
__published:
	...
	__property TOnPASVEvent OnPASV = {read=FOnPASV, write=FOnPASV};
};
