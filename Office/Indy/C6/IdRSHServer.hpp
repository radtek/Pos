...
// (DO NOT EDIT: machine generated header) 'IdRSHServer.pas' rev: 6.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TIdRSHCommandEvent)(Idtcpserver::TIdPeerThread* AThread, Idtcpclient::TIdTCPClient* AStdError, AnsiString AClientUserName, AnsiString AHostUserName, AnsiString ACommand);
