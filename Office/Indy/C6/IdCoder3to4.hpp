...
public:
	...
	/* TComponent.Create */ inline __fastcall virtual TIdEncoder3to4(Classes::TComponent* AOwner) : Idcoder::TIdEncoder(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	/*         class method */ static void __fastcall ConstructDecodeTable(TMetaClass* vmt, const AnsiString ACodingTable, Byte * ADecodeArray);
...
public:
	#pragma option push -w-inl
	/* TComponent.Create */ inline __fastcall virtual TIdDecoder4to3(Classes::TComponent* AOwner) : Idcoder::TIdDecoder(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
