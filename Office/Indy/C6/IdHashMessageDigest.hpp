...
// (DO NOT EDIT: machine generated header) 'IdHashMessageDigest.pas' rev: 6.00
...
public:
	inline unsigned __fastcall  HashValue(const AnsiString ASrc){ return TIdHash128::HashValue(ASrc); }
