...
// (DO NOT EDIT: machine generated header) 'IdIOHandler.pas' rev: 6.00
...
public:
	...
	virtual bool __fastcall Readable(int AMSec = 0xffffffff) = 0 ;
...
public:
	...
	/* TIdComponent.Create */ inline __fastcall virtual TIdIOHandler(Classes::TComponent* axOwner) : Idcomponent::TIdComponent(axOwner) { }
	#pragma option pop
