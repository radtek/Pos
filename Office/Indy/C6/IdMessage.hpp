...
protected:
	...
	AnsiString __fastcall GetContentID();
	AnsiString __fastcall GetContentType();
	AnsiString __fastcall GetContentTransfer();
	void __fastcall SetContentID(const AnsiString AValue);
	void __fastcall SetContentType(const AnsiString AValue);
	void __fastcall SetContentTransfer(const AnsiString AValue);
...
__published:
	__property AnsiString ContentID = {read=GetContentID, write=SetContentID};
...
protected:
	...
	bool FDeleteTempFile;
	AnsiString FFileName;
	AnsiString __fastcall GetContentDisposition();
	void __fastcall SetContentDisposition(const AnsiString AValue);
...
public:
	...
	bool __fastcall SaveToFile(const AnsiString AFileName);
	__property AnsiString ContentDisposition = {read=GetContentDisposition, write=SetContentDisposition};
	__property bool DeleteTempFile = {read=FDeleteTempFile, write=FDeleteTempFile, nodefault};
...
protected:
	...
	HIDESBASE void __fastcall SetItem(int Index, const TIdMessagePart* AValue);
...
typedef void __fastcall (__closure *TIdInitializeIsoEvent)(Idcoderheader::TTransfer &VTransferHeader, char &VHeaderEncoding, AnsiString &VCharSet);
...
protected:
	...
	virtual void __fastcall DoInitializeISO(Idcoderheader::TTransfer &VTransferHeader, char &VHeaderEncoding, AnsiString &VCharSet);
...
public:
	...
	void __fastcall AddHeader(const AnsiString AValue);
	...
	void __fastcall LoadFromFile(const AnsiString AFileName, const bool AHeadersOnly = false);
	void __fastcall LoadFromStream(Classes::TStream* AStream, const bool AHeadersOnly = false);
	void __fastcall ProcessHeaders(void);
	void __fastcall SaveToFile(const AnsiString AFileName, const bool AHeadersOnly = false);
...
__published:
	...
	__property bool DeleteTempFiles = {read=FDeleteTempFiles, write=FDeleteTempFiles, nodefault};
	__property TIdMessageEncoding Encoding = {read=FEncoding, write=SetEncoding, nodefault};
	__property Idheaderlist::TIdHeaderList* ExtraHeaders = {read=FExtraHeaders, write=SetExtraHeaders};
	__property Idemailaddress::TIdEMailAddressItem* From = {read=FFrom, write=SetFrom};
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdMessageCannotLoad(const AnsiString Msg) : EIdMessageException(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdMessageCannotLoad(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EIdMessageException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdMessageCannotLoad(int Ident)/* overload */ : EIdMessageException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdMessageCannotLoad(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EIdMessageException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdMessageCannotLoad(const AnsiString Msg, int AHelpContext) : EIdMessageException(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdMessageCannotLoad(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EIdMessageException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EIdMessageCannotLoad(int Ident, int AHelpContext)/* overload */ : EIdMessageException(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdMessageCannotLoad(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EIdMessageException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
