...
// (DO NOT EDIT: machine generated header) 'QRpDefine.pas' rev: 6.00
...
class PASCALIMPLEMENTATION TMetafile : public Qgraphics::TGraphic 
{
...
public:
	...
	__property Classes::TMemoryStream* ImageData = {read=FImageData, write=FImageData};
	__property HENHMETAFILE Handle = {read=FHandle, nodefault};
};


typedef TPaperSizeName QRpDefine__2[43];
...
typedef void __fastcall (__closure *TDecodeImageEvent)(System::TObject* Sender, Classes::TStream* ImageStream, AnsiString ImageType, Qgraphics::TBitmap* Bitmap);
...
extern PACKAGE Byte __fastcall GetRValue(Qgraphics::TColor AColor);
extern PACKAGE Byte __fastcall GetGValue(Qgraphics::TColor AColor);
extern PACKAGE Byte __fastcall GetBValue(Qgraphics::TColor AColor);
extern PACKAGE Qgraphics::TColor __fastcall RGB(Byte RValue, Byte GValue, Byte BValue);
extern PACKAGE Qgraphics::TColor __fastcall ShadeToColor(Qgraphics::TColor ShadeColor, Byte ShadePercent);
extern PACKAGE AnsiString __fastcall MoneyToLongName(Extended Value);
extern PACKAGE TFontCharSet __fastcall VCLToCLXCharSet(int ACharSet);
extern PACKAGE int __fastcall CLXToVCLCharSet(TFontCharSet ACharSet);
extern PACKAGE Byte __fastcall ConvertCharset(Byte Charset);

}	/* namespace Qrpdefine */
using namespace Qrpdefine;
#pragma option pop	// -w-
