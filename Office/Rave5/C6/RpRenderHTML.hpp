...
// (DO NOT EDIT: machine generated header) 'RpRenderHTML.pas' rev: 6.00
...
protected:
	...
	AnsiString __fastcall ColorToRGBString(Graphics::TColor AColor);
	void __fastcall DoGifDiv(const float AX, const float AY, const float AWidth, const float AHeight, Graphics::TColor AColor);
	AnsiString __fastcall GetFontStyle(Graphics::TFont* AFont);
	AnsiString __fastcall GetTemplate();
	AnsiString __fastcall HTMLColor(const Graphics::TColor colr);
	...
	void __fastcall ToJPEGFile(Graphics::TGraphic* AGraphic, const AnsiString AFileName);
...
public:
	...
	/*         class method */ static void __fastcall CreateColorGif(TMetaClass* vmt, Classes::TStream* AStream, Graphics::TColor AColor);
	...
	virtual void __fastcall PrintBitmapRect(const double AX1, const double AY1, const double AX2, const double AY2, Graphics::TBitmap* AGraphic);
