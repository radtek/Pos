...
// (DO NOT EDIT: machine generated header) 'RvDefine.pas' rev: 6.00
...
typedef TRaveBinName RvDefine__3[14];
...
extern PACKAGE Rpbase::TBaseReport* GBaseReport;
...
extern PACKAGE Rpdefine::TReportDest PrintDestination;
extern PACKAGE bool AllowSetup;
extern PACKAGE int PreviewShadowDepth;
extern PACKAGE Forms::TWindowState PreviewWindowState;
...
extern PACKAGE Graphics::TColor PreviewGridColor;
extern PACKAGE Graphics::TPenStyle PreviewGridPenStyle;
extern PACKAGE Rpdefine::TRulerType PreviewRulerType;
extern PACKAGE double ProjectUnitsFactor;
extern PACKAGE Rpdefine::TRavePaperSize PaperSize;
...
extern PACKAGE Graphics::TBitmap* TrueTypeFontImage;
extern PACKAGE Graphics::TBitmap* DeviceFontImage;
