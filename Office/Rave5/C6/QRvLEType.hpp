...
// (DO NOT EDIT: machine generated header) 'QRvLEType.pas' rev: 6.00
...
protected:
	Qrvledefine::TTypeKind FTypeKind;
	Qrvledefine::TTypeStruc FTypeStruc;
	int FSize;
...
public:
	__fastcall TBaseType(Qrvledefine::TTypeKind ATypeKind);
	__fastcall virtual TBaseType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual bool __fastcall NeedFree(void);
	virtual void __fastcall FreeData(void * Data);
	__property Qrvledefine::TTypeStruc TypeStruc = {read=FTypeStruc, nodefault};
	...
	__property Qrvledefine::TTypeKind TypeKind = {read=FTypeKind, nodefault};
public:
...
public:
	__fastcall TSimpleType(Qrvledefine::TTypeKind ATypeKind, int ALow, int AHigh);
	__fastcall virtual TSimpleType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
...
public:
	...
	__fastcall virtual TEnumeratedType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
...
public:
	...
	__fastcall virtual TArrayType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
...
protected:
	...
	Qrvledefine::TAddress __fastcall GetParamAddr(int Index);
	Word __fastcall GetParams(void);
	
public:
	__fastcall TFuncType(void);
	__fastcall virtual ~TFuncType(void);
	__fastcall virtual TFuncType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	...
	__property Qrvledefine::TAddress ParamAddr[int Index] = {read=GetParamAddr};
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* TFuncType.CreateFromStreamHelper */ inline __fastcall virtual TMethodType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper) : TFuncType(TypeHelper, StreamHelper) { }
	#pragma option pop
...
public:
	...
	__fastcall virtual TStructureType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	TStructureMember* __fastcall AddElement(AnsiString ID, TBaseType* BaseType);
	virtual bool __fastcall FindMember(AnsiString ID, Qrvledefine::TScopeSet ValidScopes, int &Offset, TStructureMember* &Member, int &Index);
...
protected:
	TBaseType* FBaseType;
	Qrvledefine::TMemberType FMemberType;
	TStructureType* FStructureType;
	
public:
	__fastcall virtual TStructureMember(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper, TStructureType* Structure);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	__property TBaseType* BaseType = {read=FBaseType, write=FBaseType};
	__property Qrvledefine::TMemberType MemberType = {read=FMemberType, write=FMemberType, nodefault};
...
protected:
	Qrvledefine::TScope FScope;
	
public:
	__fastcall virtual TClassMember(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper, TStructureType* Structure);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	__property Qrvledefine::TScope Scope = {read=FScope, write=FScope, nodefault};
public:
	#pragma option push -w-inl
...
public:
	__fastcall virtual TMethodMember(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper, TStructureType* Structure);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
...
public:
	__fastcall virtual TPropertyMember(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper, TStructureType* Structure);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* TStructureType.CreateFromStreamHelper */ inline __fastcall virtual TRecordType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper) : TStructureType(TypeHelper, StreamHelper) { }
	#pragma option pop
...
public:
	...
	__fastcall virtual TClassType(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual void __fastcall SaveToStreamHelper(TTypeHelper* TypeHelper, Qrvutil::TStreamHelper* StreamHelper);
	virtual bool __fastcall FindMember(AnsiString ID, Qrvledefine::TScopeSet ValidScopes, int &Offset, TStructureMember* &Member, int &Index);
	TClassMember* __fastcall AddField(AnsiString ID, TBaseType* BaseType, Qrvledefine::TScope Scope);
	TMethodMember* __fastcall AddMethod(AnsiString ID, TBaseType* BaseType, Qrvledefine::TScope Scope, TMethodOptionsSet Options);
	TPropertyMember* __fastcall AddProperty(AnsiString ID, TBaseType* BaseType, Qrvledefine::TScope Scope, int ReadIndex, int WriteIndex);
