...
// (DO NOT EDIT: machine generated header) 'QRvDataLink.pas' rev: 6.00

#ifndef QRvDataLinkHPP
#define QRvDataLinkHPP
...
public:
	...
	Qrvdlbase::TDLBaseDriver* FDriver;
	bool FInstalled;
	...
	void __fastcall ResultSetGetRow(void * ResultSetHandle, int TransferCount, Qrvdlcommon::PDLTransferFieldList TransferList, void * &RowBuffer, int &RowBufSize);
	...
	__property Qrvdlbase::TDLBaseDriver* Driver = {read=FDriver};
public:
