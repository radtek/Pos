...
// (DO NOT EDIT: machine generated header) 'QRpBars.pas' rev: 6.00
...
protected:
	...
	double CurrX;
	double CurrY;
	Qgraphics::TBrush* SaveBrush;
	Qgraphics::TPen* SavePen;
	bool FUseChecksum;
	int FModulas;
	bool FPrintReadable;
	bool FPrintChecksum;
	bool FPrintTop;
	Qrpdefine::TPrintJustify FTextJustify;
	Qrpdefine::TPrintJustify FBarCodeJustify;
...
public:
	__fastcall virtual TRPBarsBase(Qrpbase::TBaseReport* BaseRpt);
	...
	__property Qrpdefine::TPrintJustify BarCodeJustify = {read=FBarCodeJustify, write=FBarCodeJustify, nodefault};
	...
	__property Qrpdefine::TPrintJustify TextJustify = {read=FTextJustify, write=FTextJustify, nodefault};
...
public:
	__fastcall virtual TRPBarsPostNet(Qrpbase::TBaseReport* BaseRpt);
	virtual bool __fastcall IsValidChar(char Ch);
...
public:
	__fastcall virtual TRPBars2of5(Qrpbase::TBaseReport* BaseRpt);
	virtual bool __fastcall IsValidChar(char Ch);
	virtual void __fastcall Print(void);
public:
	#pragma option push -w-inl
...
public:
	__fastcall virtual TRPBarsCode39(Qrpbase::TBaseReport* BaseRpt);
	virtual bool __fastcall IsValidChar(char Ch);
	virtual void __fastcall Print(void);
...
public:
	__fastcall virtual TRPBarsCode128(Qrpbase::TBaseReport* BaseRpt);
	virtual bool __fastcall IsValidChar(char Ch);
	virtual void __fastcall Print(void);
...
public:
	__fastcall virtual TRPBarsUPC(Qrpbase::TBaseReport* BaseRpt);
	virtual bool __fastcall IsValidChar(char Ch);
	virtual void __fastcall Print(void);
public:
	#pragma option push -w-inl
...
public:
	__fastcall virtual TRPBarsEAN(Qrpbase::TBaseReport* BaseRpt);
	virtual void __fastcall PrintReadableText(void);
	virtual double __fastcall GetFontSize(void);
public:
	#pragma option push -w-inl
