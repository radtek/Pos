...
// (DO NOT EDIT: machine generated header) 'QRvDataField.pas' rev: 6.00

#ifndef QRvDataFieldHPP
#define QRvDataFieldHPP
...
class PASCALIMPLEMENTATION TRaveDataField : public Qrvclass::TRaveComponent 
{
...
protected:
	...
	bool FCalculated;
	virtual Qrpdefine::TRPDataType __fastcall GetDataType(void) = 0 ;
	...
	virtual System::TDateTime __fastcall GetAsDate(void);
	virtual System::TDateTime __fastcall GetAsTime(void);
...
public:
	...
	__property Qrpdefine::TRPDataType DataType = {read=GetDataType, nodefault};
	...
	__property System::TDateTime AsDate = {read=GetAsDate};
	__property System::TDateTime AsTime = {read=GetAsTime};
...
protected:
	virtual Qrpdefine::TRPDataType __fastcall GetDataType(void);
	virtual AnsiString __fastcall GetAsString();
public:
	#pragma option push -w-inl
