...
// (DO NOT EDIT: machine generated header) 'RpCon.pas' rev: 6.00
...
class PASCALIMPLEMENTATION TRvCustomConnection : public Rpdefine::TRpComponent 
{
...
protected:
	...
	void __fastcall CheckDataType(Rpdefine::TRPDataTypeSet ValidDataTypes);
	...
	void __fastcall ReturnError(AnsiString Msg, Rpdefine::TRaveConnectionError ErrorType);
...
public:
	...
	void __fastcall WriteField(AnsiString Name, Rpdefine::TRPDataType DataType, int Width, AnsiString FullName, AnsiString Description);
...
public:
	__fastcall TDataConnectFieldDef(Rpdefine::TRPDataType ADataType, AnsiString AFieldName, bool AIncluded);
	...
	__property Rpdefine::TRPDataType DataType = {read=FDataType, nodefault};
