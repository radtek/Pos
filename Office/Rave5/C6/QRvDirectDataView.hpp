...
// (DO NOT EDIT: machine generated header) 'QRvDirectDataView.pas' rev: 6.00

#ifndef QRvDirectDataViewHPP
#define QRvDirectDataViewHPP
...
protected:
	...
	AnsiString FName;
	bool FRuntime;
	Qt::QApplicationH* FAppHandle;
	Qrpcon::TRvCustomConnection* FConnection;
	unsigned FDataEvent;
	int FVersion;
...
public:
	...
	__property Qt::QApplicationH* AppHandle = {read=FAppHandle, write=FAppHandle};
	__property Qrpcon::TRvCustomConnection* Connection = {read=FConnection, write=FConnection};
...
class PASCALIMPLEMENTATION TRaveDataView : public Qrvdata::TRaveBaseDataView 
{
...
extern PACKAGE TRaveDataConnection* __fastcall CreateDataCon(Qrpcon::TRvCustomConnection* RPConnection);
...
using namespace Qrvdirectdataview;
#pragma option pop	// -w-
#pragma option pop	// -Vx

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// QRvDirectDataView
