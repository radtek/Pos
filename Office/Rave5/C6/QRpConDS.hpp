...
// (DO NOT EDIT: machine generated header) 'QRpConDS.pas' rev: 6.00
...
class PASCALIMPLEMENTATION TRvCustomDataSetConnection : public Qrpcon::TRvCustomConnection 
{
	typedef Qrpcon::TRvCustomConnection inherited;
