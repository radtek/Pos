...
uses
  Windows, Graphics,
  Classes, SysUtils, RpDefine, RpMBCS;
...
type
  ...
  // Drawing Methods
    ...
    procedure PrintBitmapRect(const X1,Y1,X2,Y2: double; AGraphic: Graphics.TBitmap); virtual;
    procedure PrintBitmap(const X1,Y1,ScaleX,ScaleY: double; AGraphic: Graphics.TBitmap); virtual;
    ...
    procedure FloodFill(X,Y: double; Color: TColor; FillStyle: TFillStyle); virtual;
...
begin
//!!PORT!! under Kylix, Brush.Bitmap is always non-nil - Is this WINCLX as well?
...
begin
  ...
  Renderer.FloodFill(X1,Y1,TColor(L1),TFillStyle(L2));
end;
...
begin
  ...
  FontBitmap := Graphics.TBitmap.Create;
...
procedure TRPRender.FloodFill(X,Y: double;
                              Color: TColor;
