...
uses
  Types, QControls, QGraphics, QDialogs, QButtons, QStdCtrls, QForms,
  Classes, SysUtils, QRvDefine, QRvUtil, QRvClass, QRvCsStd,
  QRvData, QRpDefine, QRpBase, QRvProj, QRvDataField;
    ...
    { Draw banner for child }
      ...
      if BandSelected or RegionSelected then begin { Draw Band Header }
        with Canvas do begin
          ...
          DrawButtonFace(Canvas,Rect,1,false,false,false);
          Dec(Rect.Left);
          Dec(Rect.Top);
