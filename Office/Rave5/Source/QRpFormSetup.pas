...
uses
  Types, QGraphics, QControls, QForms, QStdCtrls, QButtons, QDialogs, QComCtrls,
  SysUtils, Classes, QRpDevice, QRpDefine, QRpSystem, QRpRenderPrinter;
...
begin
  ...
  if Assigned(QRpRender.RenderList) then begin
    QRpRender.GetRenderList(cboxFormat.Items);
  end; { if }
